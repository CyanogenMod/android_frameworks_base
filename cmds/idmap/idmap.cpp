 ...
 *
 * SYNOPSIS
 *       idmap --fd target overlay fd path target overlay idmap scan dir-to-scan target-to-look-for
 *       idmap --target dir-to-hold-idmaps dir-to-hold-symlinks inspect idmap
 ...
 *       a symbolic link to it. The symlinks may be removed and recreated at a lower cost than
 ...
 *                package, specified in its manifest using the <overlay target="..."/> tag.
 *
 * OPTIONS
 ...
 *
 *       --scan: non-recursively search directory 'dir-to-scan' (path) for overlay packages which
 ...
 *
 *       --inspect: decode the binary format of idmap file 'idmap' (path) and display the contents
 *                  in a debug-friendly format.
 *
 * EXAMPLES
 ...
 *
 *       In this example, the overlay package provides three alternative resources: xml/integer,
 *       string/str and string/str2.
 *
 * NOTES
