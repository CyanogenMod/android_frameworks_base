...
public final class SettingsCmd {
    ...
    private static final String SETTINGS_PROVIDER = "settings";
    private static final String CMSETTINGS_PROVIDER = "cmsettings";
            ...
            try {
                ...
                try {
                    ContentProviderHolder holder = activityManager.getContentProviderExternal(
                            mUseCMSettingsProvider ? CMSETTINGS_PROVIDER : SETTINGS_PROVIDER,
