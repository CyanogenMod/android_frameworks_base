...
public:
    ...
    bool addOverlayPath(const String8& idmapPath, int32_t* cookie,
        const String8& overlayApkpath=String8 (""), const String8& resApkPath=String8 (""),
        const String8& targetPkgPath=String8 (""), const String8& prefixPath=String8 (""));
...
private:
    struct asset_path
    {
        asset_path() : path(""), type(kFileTypeRegular), idmap(""),
                       ...
                       prefixPath(""), resfilePath(""), pkgIdOverride(0),
                       resApkPath("") {}
        String8 path;
        FileType type;
        String8 idmap;
