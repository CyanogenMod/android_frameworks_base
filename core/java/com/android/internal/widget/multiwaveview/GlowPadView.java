...
public class GlowPadView extends View {
     ...
     * @hide
     */
    public final static String DEFAULT_TARGETS = "empty|#Intent;action=android.intent.action.MAIN;" +
            "category=android.intent.category.LAUNCHER;component=com.google.android.googlequicksearchbox/.SearchActivity;S.icon_resource=ic_action_assist_generic_normal;end"
            + "|empty|#Intent;action=android.intent.action.MAIN;" +
