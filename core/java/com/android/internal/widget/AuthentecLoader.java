...
public class AuthentecLoader
{
	...
	{
	    Log.e ("AuthentecLoader", "Fingerprint jar/lib location not found or invalid in build.prop");
            return;
        }
	    ...
	    Log.e ("AuthentecLoader", "Exception occurred in constructor - " + ex.toString());
            ex.printStackTrace();
            return;
        }
    }
