...
public class RotarySelector extends View {
    ...
    public void setLeftHandleResource(Drawable icon) {
        ...
        mLeftHandleIcon=Bitmap.createScaledBitmap(bmp, mDimpleWidth, mDimpleWidth, true);
        invalidate();
    }
    ...
    public void setMidHandleResource(Drawable icon) {
        Bitmap bmp = ((BitmapDrawable)icon).getBitmap();
        mMidHandleIcon=Bitmap.createScaledBitmap(bmp, mDimpleWidth, mDimpleWidth, true);
        invalidate();
    }
