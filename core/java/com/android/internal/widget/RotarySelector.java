    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mLenseMode){
            if(isHoriz()){
                ...
                mLensePaint.setTextSize(LENSE_TIME_SIZE_DIP * mDensity);
                canvas.drawText(mTimeString, mBackgroundWidth / 2, mRotaryOffsetY + mMarginBottom + LENSE_TIME_SIZE_DIP * mDensity, mLensePaint);
                mLensePaint.setTextSize(LENSE_DATE_SIZE_DIP * mDensity);
                canvas.drawText(mDate, mBackgroundWidth / 2, mRotaryOffsetY + mMarginBottom + LENSE_DATE_SIZE_DIP * mDensity * 3, mLensePaint);
            }
            return;
        }
