...
public class LockPatternUtils {
    ...
    public static final String LOCKSCREEN_FINGERPRINT_FALLBACK = "fingerprintFallback";
    ...
    */
    ...
    public void saveLockPassword(String password, int quality, boolean isFallback,
                                 boolean isFingerprintFallback) {
        saveLockPassword(password, quality, isFallback, isFingerprintFallback, getCurrentOrCallingUserId());
    }
