...
public class StatusBarIcon implements Parcelable {
    ...
    public StatusBarIcon(String iconPackage, int iconId, int iconLevel, int number, boolean hasBackground) {
        this.iconPackage = iconPackage;
        this.iconId = iconId;
        this.iconLevel = iconLevel;
        this.number = number;
    ...
    public StatusBarIcon clone() {
        StatusBarIcon that = new StatusBarIcon(this.iconPackage, this.iconId, this.iconLevel, this.hasBackground);
