...
public class ImageUtils {
    ...
    private static String queryWpPathFromComponentId(Context context, String pkgName, long componentId) {
        String wpPath = null;
        ...
        if (c != null) {
            try {
                if (c.moveToFirst()) {
                    int keyIdx = c.getColumnIndex(ThemesContract.PreviewColumns.COL_KEY);
                    wpPath = c.getString(keyIdx);
                }
            } catch(Exception e) {
