...
public class SmartPackageStatsUtils {
     ...
     */
    public ArrayList<PackageInfo> getRelevantPackagesForRightNow(Context context, int limit) {
     ...
     */
    public ArrayList<PackageInfo> getRelevantPackagesForInterval(Context context,
        ...
        Cursor c = context.getContentResolver()
                .query(SmartPackageStatsContracts.AUTHORITY_URI,
     ...
     */
    public ArrayList<PackageInfo> getMostLaunchedPackages(Context context, int limit) {
        ArrayList<PackageInfo> infos = new ArrayList<PackageInfo>();
     ...
     */
    public ArrayList<PackageInfo> getHighestUsageTimePackages(Context context, int limit) {
        ArrayList<PackageInfo> infos = new ArrayList<PackageInfo>();
        String realLimit = getRealLimit(limit, SmartPackageStatsContracts.RawStats.USAGE_TIME);
        populateListFromLimit(context, infos, realLimit);
        return infos;
    ...
    private void populateListFromLimit(Context context, ArrayList<PackageInfo> infos, String realLimit) {
        Cursor c = context.getContentResolver()
                .query(SmartPackageStatsContracts.AUTHORITY_URI,
                        new String[]{ SmartPackageStatsContracts.RawStats.PKG_NAME }
                        , null, null, realLimit);
    ...
    private PackageInfo getPackageInfoForPackageName(Context context, String pkgName) {
    ...
    private String getRealLimit(int limit, String type) {
