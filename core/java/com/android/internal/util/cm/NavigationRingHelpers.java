    ...
    public static TargetDrawable getTargetDrawable(Context context, String action) {
        ...
        if (TextUtils.isEmpty(action) || action.equals(ACTION_NONE)) {
            ...
            if (am.getRingerMode() != AudioManager.RINGER_MODE_VIBRATE) {
                resourceId = com.android.internal.R.drawable.ic_navigation_ring_vibrate;
            } else {
                resourceId = com.android.internal.R.drawable.ic_navigation_ring_sound_on;
            }
        } else if (action.equals(ACTION_SILENT)) {
            AudioManager am = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
            if (am.getRingerMode() != AudioManager.RINGER_MODE_SILENT) {
                resourceId = com.android.internal.R.drawable.ic_navigation_ring_silent;
            } else {
                resourceId = com.android.internal.R.drawable.ic_navigation_ring_sound_on;
            }
