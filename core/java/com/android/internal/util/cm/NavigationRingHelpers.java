...
public class NavigationRingHelpers {
    ...
    public static void resetActionsToDefaults(Context context) {
        ...
        Settings.System.putString(cr, Settings.System.NAVIGATION_RING_TARGETS[1],
                                         isAssistantAvailable(context) ? ACTION_ASSIST : ACTION_NONE);
