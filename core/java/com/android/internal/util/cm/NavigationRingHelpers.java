    ...
    public static void swapSearchIconIfNeeded(Context context, GlowPadView view) {
        ...
        if (intent != null) {
            ...
            if (component != null) {
                ...
                if (replaced) {
                    updateSearchIcon(context, view);
                }
            }
        }
    }

    private static void updateSearchIcon(Context context, GlowPadView view) {
            ...
            if (target != null && target.getResourceId() ==
                ...
                if (drawable instanceof StateListDrawable) {
                    ...
                    if (inActiveIndex != -1 && activeIndex != -1) {
                        StateListDrawable selector = new StateListDrawable();
                        selector.addState(TargetDrawable.STATE_INACTIVE, d.getStateDrawable(inActiveIndex));
                        selector.addState(TargetDrawable.STATE_ACTIVE, d.getStateDrawable(activeIndex));
                        selector.addState(TargetDrawable.STATE_FOCUSED, d.getStateDrawable(activeIndex));
