...
public abstract class Window {
    ...
    */
    ...
    public void setFlags(int flags, int mask) {
        if ((flags | WindowManager.LayoutParams.PREVENT_POWER_KEY) == flags){
            mContext.enforceCallingOrSelfPermission("android.permission.CAN_PREVENT_POWER_KEY", "No permission to prevent power key");
        }
        final WindowManager.LayoutParams attrs = getAttributes();
    ...
    public void setAttributes(WindowManager.LayoutParams a) {
        if ((a.flags | WindowManager.LayoutParams.PREVENT_POWER_KEY) == a.flags){
            mContext.enforceCallingOrSelfPermission("android.permission.CAN_PREVENT_POWER_KEY", "No permission to prevent power key");
        }
