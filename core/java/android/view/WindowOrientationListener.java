...
public abstract class WindowOrientationListener {
    ...
    private static final int ROTATION_0_INTRODUCED_BM = 16;
    private static final int ROTATION_0_BM = 8;
    private static final int ROTATION_90_BM = 1;
    private static final int ROTATION_180_BM = 2;
    private static final int ROTATION_270_BM = 4;
    private static int sAccelerometerMode =
        ROTATION_0_INTRODUCED_BM|ROTATION_0_BM|ROTATION_90_BM|ROTATION_270_BM;
    ...
    static class SensorEventListenerImpl implements SensorEventListener {
        ...
        private void calculateNewRotation(float orientation, float tiltAngle) {
            ...
            switch (rotation) {
                case ROTATION_0:
                    allowed = (sAccelerometerMode & ROTATION_0_BM) != 0 ||
                              (sAccelerometerMode & ROTATION_0_INTRODUCED_BM) == 0;
                    break;
                case ROTATION_90:
                    allowed = (sAccelerometerMode & ROTATION_90_BM) != 0;
                    break;
                case ROTATION_180:
                    allowed = (sAccelerometerMode & ROTATION_180_BM) != 0;
                    break;
                case ROTATION_270:
                    allowed = (sAccelerometerMode & ROTATION_270_BM) != 0;
                    break;
            }
            if (!allowed) {
