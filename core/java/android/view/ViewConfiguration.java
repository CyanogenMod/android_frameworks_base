...
public class ViewConfiguration {
    ...
    private GlobalSettingsObserver mMenuKeyObserver;
    ...
    private ViewConfiguration(Context context) {
        ...
        mMenuKeyObserver = GlobalSettingsObserver.getInstance(context);
        mMenuKeyObserver.observe();
     ...
     */
    public boolean hasPermanentMenuKey() {
        return mMenuKeyObserver.hasPermanentMenuKey();
    }
