...
public class ApduServiceInfo implements Parcelable {
     ...
     */
    protected ArrayList<String> mNfcid2s;
     ...
     */
    protected ArrayList<Nfcid2Group> mNfcid2Groups;
    ...
    protected HashMap<String, Nfcid2Group> mNfcid2CategoryToGroup;
     ...
     *
     */
    protected boolean mServiceState;
    /**
    ...
    /**
      * nxp se extension
      */
    protected ESeInfo mSeExtension;
    protected FelicaInfo mFelicaExtension;
    ...
    public List<String> getAids() {
        final List<String> aids = new ArrayList<String>();
    ...
    /**@hide */
    public List<AidGroup> getStaticAidGroups() {
        final List<AidGroup> groups = new ArrayList<AidGroup>();
    ...
    /**@hide */
    public List<AidGroup> getDynamicAidGroups() {
        final ArrayList<AidGroup> groups = new ArrayList<AidGroup>();
        for (Map.Entry<String, AidGroup> entry : mDynamicAidGroups.entrySet()) {
            groups.add(entry.getValue());
        }
    ...
    public List<Nfcid2Group> getNfcid2Groups() {
