...
public class ThemesContract {
    ...
    public static class PreviewColumns {
        ...
        // WALLPAPER_FULL - path to the full-sized image in the theme assets directory
        public static final String WALLPAPER_FULL = "wallpaper_full";
        // WALLPAPER_PREVIEW - scaled and cropped version of the full size wallpaper
        public static final String WALLPAPER_PREVIEW = "wallpaper_preview";
        // WALLPAPER_THUMBNAIL - scaled version of the preview size wallpaper
        public static final String WALLPAPER_THUMBNAIL = "wallpaper_thumbnail";
        // LOCK_WALLPAPER_PREVIEW - scaled and cropped version of the full size wallpaper
        public static final String LOCK_WALLPAPER_PREVIEW = "lock_wallpaper_preview";
        // LOCK_WALLPAPER_THUMBNAIL - scaled version of the preview size wallpaper
