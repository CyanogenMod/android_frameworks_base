...
public class ThemesContract {
    ...
    public static class PreviewColumns {
        ...
        // KEY_WALLPAPER_THUMBNAIL - scaled and cropped version of the preview size wallpaper
        public static final String KEY_WALLPAPER_THUMBNAIL = "wallpaper_thumbnail";
        // KEY_LOCK_WALLPAPER_FULL - path to the full-sized image in the theme assets directory
        public static final String KEY_LOCK_WALLPAPER_FULL = "lock_wallpaper_full";
        ...
        // KEY_LOCK_WALLPAPER_THUMBNAIL - scaled and cropped version of the preview size wallpaper
