    ...
    public void updateConfiguration(Configuration config,
        ...
        synchronized (mAccessLock) {
            ...
            if (mConfiguration.densityDpi != Configuration.DENSITY_DPI_UNDEFINED) {
                ...
                if ((!mCompatibilityInfo.isScalingRequired() || mCompatibilityInfo.alwaysSupportsScreen())
                        || (mCompatibilityInfo.neverSupportsScreen() && mCompatibilityInfo.isScalingRequired())
