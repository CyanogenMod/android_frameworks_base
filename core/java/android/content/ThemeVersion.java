...
public class ThemeVersion {
     ...
     * must change as well.
     *
     * If a new feature is adyded to a component (ex rotations in icon packs), the current version
    ...
    public static enum ComponentVersion {
        ...
        private ComponentVersion(int minSupportedVersion, int currentVersion) {
