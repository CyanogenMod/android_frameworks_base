...
public abstract class Service extends ContextWrapper implements ComponentCallbacks2 {
    ...
    final int dispatchStartCommand(Intent intent, int flags, int startId) {
    ...
    final IBinder dispatchBind(Intent intent) {
    ...
    final boolean dispatchUnbind(Intent intent) {
    ...
    final void dispatchRebind(Intent intent) {
        onRebind(intent);
    }
    ...
    final void dispatchTaskRemoved(Intent rootIntent) {
