...
public class ResourcesManager {
    ...
    private void setActivityIcons(Resources r) {
        ...
        if (pkgInfo != null && pkgInfo.applicationInfo != null) {
            ...
            if (appInfo.icon != 0 &&
                    (appInfo.themedIcon != 0 || iconResources.get(appInfo.icon) == null)) {
        ...
        try {
            ...
            r.setCustomIcons(iconBack != null ? new BitmapDrawable(r, iconBack) : null,
                    iconMask != null ? new BitmapDrawable(r, iconMask) : null,
                    iconUpon != null ? new BitmapDrawable(r, iconUpon) : null, iconScale);
            ...
            if (r != null) {
                ...
                if (themeChanged) {
                    ...
                    if (am.hasThemeSupport()) {
                        ...
                        r.setCustomIcons(null, null, null, 1.0f);
