...
public class IconPackHelper {
    ...
    public static class IconCustomizer {
        ...
        public static Drawable getComposedIconDrawable(Drawable icon, Resources res,
            ...
            if (iconInfo.swatchType != ComposedIconInfo.SwatchType.None) {
                ...
                if (iconInfo.defaultSwatchColors.length > 0) {
                    defaultPaletteColor = iconInfo.defaultSwatchColors[
            ...
            Bitmap bmp = createIconBitmap(icon, res, back, iconInfo.iconMask, iconInfo.iconUpon,
                    ...
                    iconInfo.swatchType, defaultPaletteColor);
        ...
        public static void getValue(Resources res, int resId, TypedValue outValue,
            ...
            if (!(new File(outValue.string.toString()).exists())) {
                ...
                Bitmap bmp = createIconBitmap(baseIcon, res, back, iconInfo.iconMask,
                        ...
                        iconInfo.colorFilter, iconInfo.swatchType, defaultPaletteColor);
        ...
        private static Bitmap createIconBitmap(Drawable icon, Resources res, int iconBack,
                ...
                ComposedIconInfo.SwatchType swatchType, int defaultPaletteColor) {
            ...
            if (icon instanceof PaintDrawable) {
                ...
                if (swatchType != ComposedIconInfo.SwatchType.None) {
                    ...
                    switch (swatchType) {
                        case Vibrant:
                            backTintColor = palette.getVibrantColor(defaultPaletteColor);
                            break;
                        case VibrantLight:
                            backTintColor = palette.getLightVibrantColor(defaultPaletteColor);
                            break;
                        case VibrantDark:
                            backTintColor = palette.getDarkVibrantColor(defaultPaletteColor);
                            break;
                        case Muted:
                            backTintColor = palette.getMutedColor(defaultPaletteColor);
                            break;
                        case MutedLight:
                            backTintColor = palette.getLightMutedColor(defaultPaletteColor);
                            break;
                        case MutedDark:
                            backTintColor = palette.getDarkMutedColor(defaultPaletteColor);
                            break;
                    }
                    if (DEBUG) {
