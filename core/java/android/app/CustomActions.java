...
public final class CustomActions implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelableArray(
                mCustomActions.toArray(new CustomAction[mCustomActions.size()]), 0);
    }

    /** @hide */
    public void readFromParcel(Parcel in) {
        mDirty = in.readInt() != 0;
        Object[] customActionArray = in.readArray(CustomAction.class.getClassLoader());
        mCustomActions = Arrays.asList((CustomAction[])customActionArray);
    }
