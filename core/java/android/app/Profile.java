...
public final class Profile implements Parcelable, Comparable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        ArrayList<ParcelUuid> tags = new ArrayList<ParcelUuid>(mSecondaryUuids.size());
    ...
    public void getXmlString(StringBuilder builder, Context context) {
        ...
        builder.append("<secondary-uuids>");
        for (UUID u : mSecondaryUuids) {
            builder.append("<secondary-uuid>");
    ...
    private static List<UUID> readTagsFromXml(XmlPullParser xpp, Context context) throws XmlPullParserException,
        ...
        int event = xpp.next();
        while (event != XmlPullParser.END_TAG || !xpp.getName().equals("secondary-uuids")) {
            if (event == XmlPullParser.START_TAG) {
                String name = xpp.getName();
                if (name.equals("secondary-uuid")) {
                    try {
    ...
    public static Profile fromXml(XmlPullParser xpp, Context context)
        ...
        while (event != XmlPullParser.END_TAG) {
            if (event == XmlPullParser.START_TAG) {
                String name = xpp.getName();
                if (name.equals("secondary-uuids")) {
                    profile.setSecondaryUuids(readTagsFromXml(xpp, context));
                }
