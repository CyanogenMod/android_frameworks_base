...
public final class Profile implements Parcelable, Comparable {
    ...
    public static class AirplaneMode {
        ...
        public static final int ENABLE_NFC = 2;
    ...
    private void doSelectAirplaneMode(Context context) {
        if (getAirplaneMode() != AirplaneMode.DEFAULT) {
            ...
            if (current == 1 && target == AirplaneMode.DISABLE || current == 0
                    && (target == AirplaneMode.ENABLE || target == AirplaneMode.ENABLE_NFC)) {
                if (target == AirplaneMode.ENABLE_NFC) {
                    String s = Settings.System.getString(context.getContentResolver(), Settings.System.AIRPLANE_MODE_RADIOS);
                    if (!TextUtils.isEmpty(s) && s.contains(Settings.System.RADIO_NFC)) {
                        s = s.replace(Settings.System.RADIO_NFC, "").replace(",,", ",");
                    }
                    Settings.System.putString(context.getContentResolver(), Settings.System.AIRPLANE_MODE_RADIOS, s);
                } else if (target == AirplaneMode.DISABLE) {
                    String s = Settings.System.getString(context.getContentResolver(),
                            Settings.System.AIRPLANE_MODE_RADIOS);
                    boolean dirty = false;
                    if (TextUtils.isEmpty(s)) {
                        s = Settings.System.RADIO_NFC;
                        dirty = true;
                    } else if (!s.contains(Settings.System.RADIO_NFC)) {
                        s += "," + Settings.System.RADIO_NFC;
                        dirty = true;
                    }
                    if (dirty) {
                        Settings.System
                                .putString(context.getContentResolver(), Settings.System.AIRPLANE_MODE_RADIOS, s);
                    }
                }
