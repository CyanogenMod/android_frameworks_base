...
public class Profile implements Parcelable {
    ...
    */
    ...
    public void getXmlString(StringBuilder builder) {
        builder.append("<profile name=\"" + TextUtils.htmlEncode(getName()) + "\" uuid=\"" + TextUtils.htmlEncode(getUuid().toString()) + "\">\n");
        builder.append("<statusbar>" + TextUtils.htmlEncode((getStatusBarIndicator() ? "yes" : "no")) + "</statusbar>\n");
        ...
        while (event != XmlPullParser.END_TAG) {
            if (event == XmlPullParser.START_TAG) {
                ...
                if (name.equals("statusbar")) {
                    profile.setStatusBarIndicator(xpp.nextText() == "yes" ? true : false);
                }
