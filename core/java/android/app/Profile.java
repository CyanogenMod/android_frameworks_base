...
public final class Profile implements Parcelable, Comparable {
    ...
    public static class ProfileTrigger implements Parcelable {
        ...
        public ProfileTrigger(int type, String id, int state, String name, String packageOwner,
                              String stringState) {
            this(type, id, state, name);
        ...
        public static ProfileTrigger fromXml(XmlPullParser xpp, Context context) {
            ...
            if (type == TriggerType.STRING) {
                ...
                return new ProfileTrigger(type, id, state, triggerName, packageOwner, triggerState);
            } else {
