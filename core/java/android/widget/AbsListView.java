    ...
    public void setOverScrollMode(int mode) {
        if (mode != OVER_SCROLL_NEVER) {
            if (mEdgeGlowTop == null) {
                ...
                int overStatus = Settings.System.getInt(mContext.getContentResolver(), Settings.System.OVERSCROLL_EFFECT,0);
                int overColor = Settings.System.getInt(mContext.getContentResolver(), Settings.System.OVERSCROLL_COLOR,0);
