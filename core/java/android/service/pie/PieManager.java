 ...
 * See {@code IPieService} for more information.
 * <p>
...
public class PieManager {
    ...
    public static abstract class PieActivationListener  {
        ...
        private class Delegator extends IPieActivationListener.Stub {
            public void onPieActivation(final int touchX, final int touchY, final int positionIndex, final int flags)
                ...
                mHandler.post(new Runnable() {
                    public void run() {
                        PieActivationListener.this.onPieActivation(touchX, touchY, positionIndex, flags);
                    }
                });
            }
        }
        ...
        public abstract void onPieActivation(int touchX, int touchY, int positionIndex, int flags);
    ...
    /**
     * Checks if the pie manager is able to register listeners at the pie service.
     *
