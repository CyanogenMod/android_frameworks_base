...
public class BatteryManager {
    ...
    /**
     * Extra for {@link android.content.Intent#ACTION_BATTERY_CHANGED}:
     * boolean containing if the device support dock batteries.
     * @hide
     */
    public static final String EXTRA_DOCK_SUPPORTED = "dock_supported";
    ...
    /** Power source is an dock AC charger.
     * @hide
     * */
    public static final int BATTERY_PLUGGED_DOCK_AC = 8;

    /** @hide */
    public static final int BATTERY_PLUGGED_ANY =
            BATTERY_PLUGGED_AC | BATTERY_PLUGGED_USB |
            BATTERY_PLUGGED_WIRELESS | BATTERY_PLUGGED_DOCK_AC;
}
