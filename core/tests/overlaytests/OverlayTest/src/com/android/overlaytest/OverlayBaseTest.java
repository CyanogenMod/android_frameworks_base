...
public abstract class OverlayBaseTest extends AndroidTestCase {
    ...
    public void testBooleanOverlay() throws Throwable {
        // rro_test_usually_false has the value:
        ...
        final int resId = com.android.internal.R.bool.rro_test_usually_false;
        assertResource(resId, false, true, false);
    }

    public void testBoolean() throws Throwable {
        // rro_test_always_true has no overlay
        final int resId = com.android.internal.R.bool.rro_test_always_true;
        assertResource(resId, true, true, true);
    }

    public void testStringOverlay() throws Throwable {
        // rro_test_animal has an overlay (default config), which shouldn't shadow
        // the Swedish translation
        final int resId = com.android.internal.R.string.rro_test_animal;
        setLocale("sv_SE");
        assertResource(resId, "katt", "katt", "katt");
    }

    public void testStringSwedishOverlay() throws Throwable {
        // rro_test_fruit has overlay only for lang=sv. The values are applied as follows:
        // - "pineapple" when no overlay exists (MODE_NO_OVERLAY)
        // - "ananas" when a single overlay exists (MODE_SINGLE_OVERLAY)
        // - "banan overlay Jobb" when multiple overlays exists (MODE_MULTIPLE_OVERLAYS)
        final int resId = com.android.internal.R.string.rro_test_fruit;
        setLocale("en_US");
        assertResource(resId, "pineapple", "pineapple", "pineapple");
        setLocale("sv_SE");
        assertResource(resId, "pineapple", "ananas", "banan");
    }

    public void testString() throws Throwable {
        // rro_test_opera has no overlay
        final int resId = com.android.internal.R.string.rro_test_opera;
        assertResource(resId, "Tosca", "Tosca", "Tosca");
    }

    public void testIntegerArrayOverlay() throws Throwable {
        // rro_test_fibonacci has values:
        ...
        final int resId = com.android.internal.R.array.rro_test_fibonacci;
    ...
    public void testIntegerArray() throws Throwable {
        // rro_test_prime_numbers has no overlay
        final int resId = com.android.internal.R.array.rro_test_prime_numbers;
    ...
    public void testAsset() throws Throwable {
        // drawable-nodpi/rro_test_drawable has overlay (default config)
        final int resId = com.android.internal.R.drawable.rro_test_drawable;
