    ...
    public void onScreenTurnedOff(int why) {
        synchronized (this) {
            ...
            if (mExitSecureCallback != null) {
                ...
                int securityTimeoutDelay = Settings.System.getInt(cr,
                        Settings.System.SECURITY_LOCK_TIMEOUT, 0);
                ...
                // that disables the security lock.
                if(securityTimeoutDelay > 0) {
                    mUpdateMonitor.setKeyguardDelayed(true);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(DELAYED_KEYGUARD_ACTION)) {
                ...
                if (mDelayedShowingSequence == sequence) {
                    ...
                    mUpdateMonitor.setKeyguardDelayed(false);
