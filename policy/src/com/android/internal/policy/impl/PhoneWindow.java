...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    public final boolean onKeyDownPanel(int featureId, KeyEvent event) {
        ...
        boolean mCustomLongMenuSoftKeyboard = (Settings.System.getInt(getContext().getContentResolver(),Settings.System.USE_CUSTOM_LONG_MENU_SOFT, 0) == 1);
        if (event.getRepeatCount() == 0) {
            ...
            mPanelChordingKey = 0;
            mPanelMayLongPress = false;
            if (!mCustomLongMenuSearchToggle && !mCustomLongMenuAppToggle && !mCustomLongMenuSoftKeyboard) {
                return false;
            }else if (mCustomLongMenuSoftKeyboard){
