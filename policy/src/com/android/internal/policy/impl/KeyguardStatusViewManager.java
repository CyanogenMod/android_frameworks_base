        ...
        if (mWeatherPanel != null) {
            ...
            if (mWeatherUpdateTime != null) {
                ...
                if (now - w.last_sync < 60000) {
                    lastSyncText = getContext().getString(R.string.weather_last_sync_just_now);
                } else {
                    lastSyncText = DateUtils.getRelativeTimeSpanString(w.last_sync, now, DateUtils.MINUTE_IN_MILLIS);
                }
                mWeatherUpdateTime.setText();
