...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    // needed for new volume button handling
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mUnhideButton = translateUnhideIndexToKeycode(Settings.System.getInt(resolver,
...
//        if(hasHandledUnhideButton(keyCode))
//            return 0;
    ...
    private boolean hasHandledUnhideButton(int keyCode){
