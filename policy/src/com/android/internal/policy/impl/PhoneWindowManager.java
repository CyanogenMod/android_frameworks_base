...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private int mPressOnSearchBehavior = -1;
    private int mLongPressOnSearchBehavior = -1;
    ...
    private void triggerVirtualKeypress(final int keyCode) {
        new Thread(new Runnable() {
            public void run() {
                ...
                int actionUp = KeyEvent.ACTION_UP;
                int RepeatCount = 0;
                int MetaState = 0;
                int DeviceId = KeyCharacterMap.VIRTUAL_KEYBOARD;
                int Scancode = 0;
                ...
                final KeyEvent ev_down = new KeyEvent(now, now, actionDown, keyCode, RepeatCount,
                                    MetaState, DeviceId, Scancode, flags, source);
                mInputManager.injectInputEvent(ev_down, InputManager.INJECT_INPUT_EVENT_MODE_ASYNC);
                
                final KeyEvent ev_up = new KeyEvent(now, now, actionUp, keyCode, RepeatCount,
                                    MetaState, DeviceId, Scancode, flags, source);
                mInputManager.injectInputEvent(ev_up, InputManager.INJECT_INPUT_EVENT_MODE_ASYNC);
    ...
    public void init(Context context, IWindowManager windowManager,
        ...
        mHasSearchKey = ((mDeviceHardwareKeys & KEY_MASK_SEARCH) != 0);
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            if (mHasAppSwitchKey) {
                mPressOnAppSwitchBehavior = Settings.System.getInt(mContext.getContentResolver(),
                        Settings.System.KEY_APP_SWITCH_ACTION, KEY_ACTION_APP_SWITCH);
                mLongPressOnAppSwitchBehavior = Settings.System.getInt(mContext.getContentResolver(),
