...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    // Behavior of camera wake (dual-stage)
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mCameraWakeScreen = (Settings.System.getIntForUser(resolver,
                    Settings.System.CAMERA_WAKE_SCREEN, 0, UserHandle.USER_CURRENT) == 2);
            ...
            mCameraMusicControls = ((Settings.System.getIntForUser(resolver,
                    ...
                    && (Settings.System.getIntForUser(resolver,
                    Settings.System.CAMERA_WAKE_SCREEN, 0, UserHandle.USER_CURRENT) == 0));
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags, boolean isScreenOn) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_FOCUS:
                if (down && !isScreenOn && mFocusWakeScreen) {
                    if (keyguardActive) {
                        mKeyguardMediator.onWakeKeyWhenKeyguardShowingTq(keyCode);
                    } else {
                        result |= ACTION_WAKE_UP;
                    ...
                    if (mCameraKeyPressable) {
                        if (down) {
                            Message msg = mHandler.obtainMessage(MSG_DISPATCH_VOLKEY_WITH_WAKE_LOCK,
                                    new KeyEvent(event.getDownTime(), event.getEventTime(), event.getAction(), KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE, 0));
