...
public class PhoneWindowManager implements WindowManagerPolicy {
        ...
        if (isDefaultDisplay) {
            ...
            if (mNavigationBar != null) {
                ...
                boolean simulateTransientBarShowing = expandedDesktopHidesNavigationBar()
                        && (navVisible || (isKeyguardLocked() && mShowSystemBarOnKeyguard));
    ...
    private int updateSystemUiVisibilityLw() {
        ...
        mWindowIsKeyguardWithBars = mShowSystemBarOnKeyguard && windowType == TYPE_KEYGUARD;
        ...
        if (windowWasKeyguardWithBars && !mWindowIsKeyguardWithBars && !isKeyguardLocked()) {
            // Keyguard was unlocked and system bars was visible. Make it transient now.
            if (expandedDesktopHidesStatusBar()) {
                mStatusBarController.showTransient();
                visibility |= View.STATUS_BAR_TRANSIENT;
    ...
    private int updateSystemBarsLw(WindowState win, int oldVis, int vis) {
        ...
        final boolean systemBarsOnKeyguard = mShowSystemBarOnKeyguard && isKeyguardLocked();
        if (!expandedDesktopHidesStatusBar() || systemBarsOnKeyguard) {
            vis = mStatusBarController.applyTranslucentFlagLw(transWin, vis, oldVis);
        }
        if (!expandedDesktopHidesNavigationBar() || systemBarsOnKeyguard) {
