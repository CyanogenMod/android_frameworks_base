...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private void updateKeyAssignments() {
        ...
        useWakeMenu = (activeHardwareWakeKeys & KEY_MASK_MENU) != 0;
        useWakeHome = (activeHardwareWakeKeys & KEY_MASK_HOME) != 0;
        useWakeBack = (activeHardwareWakeKeys & KEY_MASK_BACK) != 0;
        useWakeVolume = (activeHardwareWakeKeys & KEY_MASK_VOLUME) != 0;;
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_HOME:
                if (down && !interactive && mHomeWakeScreen && useWakeHome) {
                    isWakeKey = true;
                }
                break;
    ...
    private boolean isWakeKeyWhenScreenOff(int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_DOWN:
            case KeyEvent.KEYCODE_VOLUME_MUTE:
                return (mVolumeWakeScreen && useWakeVolume) || mDockMode != Intent.EXTRA_DOCK_STATE_UNDOCKED;
            ...
            case KeyEvent.KEYCODE_BACK:
                return (mBackWakeScreen && useWakeBack);
            case KeyEvent.KEYCODE_MENU:
                return (mMenuWakeScreen && useWakeMenu);
        }
        return true;
    }
