...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private int updateSystemUiVisibilityLw() {
        ...
        mWindowIsKeyguardWithBars = mShowSystemBarOnKeyguard && mKeyguard != null && mKeyguard.isVisibleLw();
    ...
    private int updateSystemBarsLw(WindowState win, int oldVis, int vis) {
        ...
        final boolean systemBarsOnKeyguard = mShowSystemBarOnKeyguard
                && mKeyguard != null && mKeyguard.isVisibleLw();
        if (systemBarsOnKeyguard) {
