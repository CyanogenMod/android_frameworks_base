...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    Integer[] mUserRotationAngles = new Integer[] {
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            if (modes == null) {
                mUserRotationAngles = new Integer[] {
                        Surface.ROTATION_0, Surface.ROTATION_90, Surface.ROTATION_180, Surface.ROTATION_270
                };
                ...
                mUserRotationAngles = new Integer[modes.length];
                for (int i = 0; i < modes.length; i++) {
                    mUserRotationAngles[i] = Integer.valueOf(modes[i]);
                }
            }
    ...
    public int rotationForOrientationLw(int orientation, int lastRotation) {
        ...
        synchronized (mLock) {
            ...
            if (mLidOpen == LID_OPEN && mLidOpenRotation >= 0) {
                ...
                if (Arrays.asList(mUserRotationAngles).contains(sensorRotation)) {
