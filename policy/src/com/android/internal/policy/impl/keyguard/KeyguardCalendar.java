...
public class KeyguardCalendar extends LinearLayout {
    ...
    public static final int  MAX_CALENDAR_ITEMS = 1;
    ...
    public void refreshCalendar() {
        ...
        mCalendarEventTitle = (TextView) findViewById(R.id.keyguard_calendar_event_title);
        mCalendarEventDetails = (TextView) findViewById(R.id.keyguard_calendar_event_details);
        ...
        if (mCalendarPanel != null) {
            ...
            if (lockCalendar) {
                tempCalendars = getNextCalendarAlarm(lockCalendarLookahead,
                        calendars, lockCalendarRemindersOnly, hideAllDay);
                nextCalendar = tempCalendars[0];
