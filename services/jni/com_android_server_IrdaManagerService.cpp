...
static void sendIrCode_native(JNIEnv *env, jobject clazz, int ptr, jbyteArray buffer)
{
    irda_device_t* dev = (irda_device_t*)ptr;
    ...
    dev->sendIrCode((char*) transmitBuffer, env->GetArrayLength(buffer));
...
static JNINativeMethod method_table[] = {
    ...
    { "sendIrCode_native", "(I[B)V", (void*)sendIrCode_native },
};
