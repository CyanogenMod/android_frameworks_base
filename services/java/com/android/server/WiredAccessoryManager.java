...
final class WiredAccessoryManager implements WiredAccessoryCallbacks {
    ...
    class WiredAccessoryObserver extends UEventObserver {
        ...
        private List<UEventInfo> makeObservedUEventList() {
            ...
            // Monitor for HTC Wired Headset with mic.
            uei = new UEventInfo("Headset", BIT_HEADSET_NO_MIC, 0); 
            if (uei.checkSwitchExists()) {
                retVal.add(uei);
            } else {
                Slog.w(TAG, "This kernel does not have wired headset w/microphone support");
            }
        ...
        private final class UEventInfo {
            ...
            if (name.equals("usb_audio")) {
               switchState = ((mHeadsetState & (BIT_HEADSET|BIT_HEADSET_NO_MIC|BIT_HDMI_AUDIO)) | ((state == 1) ? BIT_USB_HEADSET_ANLG :
