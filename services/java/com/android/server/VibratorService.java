...
public class VibratorService extends IVibratorService.Stub {
    ...
    private boolean inQuietHours() {
        boolean mQuietHoursEnabled = Settings.System.getInt(mContext.getContentResolver(),Settings.System.QUIET_HOURS_ENABLED, 0) != 0;
        int mQuietHoursStart = Settings.System.getInt(mContext.getContentResolver(),Settings.System.QUIET_HOURS_START, 0);
        int mQuietHoursEnd = Settings.System.getInt(mContext.getContentResolver(),Settings.System.QUIET_HOURS_END, 0);
        boolean mQuietHoursHaptic = Settings.System.getInt(mContext.getContentResolver(),Settings.System.QUIET_HOURS_HAPTIC, 0) != 0;
