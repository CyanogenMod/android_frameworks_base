        ...
        try {
            ...
            while (true) {
                ...
                if (TAG_STORAGE.equals(element)) {
                    ...
                    String runtimeConfigLabel = a.getString(
                            com.android.internal.R.styleable.Storage_runtimeConfigLabel);

                    if (runtimeConfigLabel != null) {
                        String prefix = "ro.mnt." + runtimeConfigLabel;
                        ...
                        allowMassStorage = SystemProperties.getBoolean(prefix + ".allowUMS",
                                allowMassStorage);
                        mtpReserve = SystemProperties.getInt(prefix + ".mtpReserve", mtpReserve);
                        maxFileSize = SystemProperties.getInt(prefix + ".maxFileSize", maxFileMbs) *
                                1024L * 1024L;
                    }
