...
public class PieService extends IPieService.Stub {
    ...
    private void updateMonitoring() {
        synchronized(mLock) {
            ...
            if (mInputFilter == null && notFilteredPosition != 0) {
                enforceMonitoringLocked();
            } else if (mInputFilter != null && notFilteredPosition == 0) {
