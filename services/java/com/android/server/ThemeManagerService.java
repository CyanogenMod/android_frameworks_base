...
public class ThemeManagerService extends IThemeManager.Stub {
    ...
    private static CustomTheme mCustomTheme = null;
    ...
    public int getCurrentTheme(){
        try	{	
            ...
            mCustomTheme = mCurConfig.customTheme;
            mCurrentResourceTheme = mCustomTheme.getThemeId();
            mPackageName = mCustomTheme.getThemePackageName();
