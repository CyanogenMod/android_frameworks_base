...
public class Tethering extends INetworkManagementEventObserver.Stub {
    ...
    private WifiClientScanner mWifiClientScanner;
    ...
    private void sendTetherStateChangedBroadcast() {
        ...
        mWifiClientScanner = new WifiClientScanner();
        ...
        if (wifiTethered) {
            mWifiClientScanner.resume();
        } else {
            mWifiClientScanner.pause();
        }
        ...
        try {
            ...
            try {
                ...
                if (mWifiClientsOldNum != currentClientsNum) {
                    ...
                    CharSequence message = r.getQuantityString(com.android.internal.R.plurals.tethered_clients_connected, currentClientsNum, currentClientsNum);
