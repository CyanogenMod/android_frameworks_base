    ...
    implements WindowManagerService.OnHardKeyboardStatusChangeListener
{
    ...
    public void updateSettings() {
        mUnhideStatusBarOnNotification = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.STATUS_BAR_UNHIDE_ON_NOTIFICATION, 0) == 1;
    }
    ...
    public StatusBarManagerService(Context context, WindowManagerService windowManager) {
        ...
        mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(
                Settings.System.STATUS_BAR_UNHIDE_ON_NOTIFICATION), false, mSettingsObserver);
        updateSettings();
    }
