...
class RotationSwitchObserver extends UEventObserver {
    ...
    private static final String LOCK_UEVENT_MATCH = "DEVPATH=/devices/virtual/switch/rotationlock";
    private static final String LOCK_STATE_PATH = "/sys/class/switch/rotationlock/state";
