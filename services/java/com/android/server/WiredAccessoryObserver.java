...
class WiredAccessoryObserver extends UEventObserver {
    ...
    private static String sDockNames[]=Resources.getSystem().getStringArray(com.android.internal.R.array.config_accessoryDockNames);
    ...
    private static class UEventInfo {
        ...
        } else if (Arrays.asList(sDockNames).contains(name)) {
             switchState = ((mHeadsetState & (BIT_HEADSET|BIT_HEADSET_NO_MIC|BIT_HDMI_AUDIO)) |
    ...
    public void onUEvent(UEventObserver.UEvent event) {
        ...
        try {
            ...
            if (Arrays.asList(sDockNames).contains(name)) {
