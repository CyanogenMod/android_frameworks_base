...
class WiredAccessoryObserver extends UEventObserver {
    ...
    private static class UEventInfo {
        ...
        } else if (Arrays.binarySearch(Resources.getSystem().getStringArray(com.android.internal.R.array.config_accessoryDockNames),name)>=0) {
             switchState = ((mHeadsetState & (BIT_HEADSET|BIT_HEADSET_NO_MIC|BIT_HDMI_AUDIO)) |
    ...
    public void onUEvent(UEventObserver.UEvent event) {
        ...
        try {
            ...
            if (Arrays.binarySearch(Resources.getSystem().getStringArray(com.android.internal.R.array.config_accessoryDockNames),name)>=0) {
