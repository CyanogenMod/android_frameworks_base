...
class WiredAccessoryObserver extends UEventObserver {
    ...
    private final void sendIntent(int headset, int headsetState, int prevHeadsetState, String headsetName) {
        if ((headsetState & headset) != (prevHeadsetState & headset)) {
            if (LOG) Slog.v(TAG, "headset: "+headset+" headsetState: "+headsetState+" prevHeadsetState: "+prevHeadsetState+" headsetName: "+headsetName);
            int state = 0;
		...
		String intentDebugString = "";
                ...
                if (headset == BIT_USB_HEADSET_ANLG) {
                    ...
                    intentDebugString = "Intent.ACTION_HDMI_AUDIO_PLUG";
                ...
                if (LOG) Slog.v(TAG, intentDebugString+": state: "+state+" name: "+headsetName);
