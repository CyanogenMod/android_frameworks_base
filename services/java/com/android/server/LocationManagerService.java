...
public class LocationManagerService extends ILocationManager.Stub implements Runnable {
    ...
    private boolean isIncognito(int pid) {
        try {
            if (ActivityManagerNative.getDefault().isProcessIncognito(pid)) {
                Slog.i(TAG, "Location services unavailable to incognito process pid=" + pid);
                return true;
            }
        } catch (RemoteException e) {
            // nothing
    ...
    public List<String> getProviders(Criteria criteria, boolean enabledOnly) {
        if (isIncognito(Binder.getCallingPid())) {
    ...
    private void requestLocationUpdatesLocked(LocationRequest request, Receiver receiver,
        ...
        if (isProviderEnabled && !isIncognito(pid)) {
