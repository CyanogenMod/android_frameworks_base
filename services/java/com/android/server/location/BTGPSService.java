    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
        	...
        	try {
	            ...
	            // Reset the ConnectThread because we're done. The server accept thread is handling everything.        
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    Message msg = null;
                    if (bytes > 0) {
                    	msg = mHandler.obtainMessage(BTGpsLocationProvider.GPS_DATA_AVAILABLE, buffer);
                    } else {
