...
public class ThemeService extends IThemeService.Stub {
    ...
    private boolean setCustomLockScreenWallpaper(String pkgName) {
        try {
            if (HOLO_DEFAULT.equals(pkgName)) {
                ...
                Context themeCtx = mContext.createPackageContext(pkgName, Context.CONTEXT_IGNORE_SECURITY);
                AssetManager assetManager = themeCtx.getAssets();
    ...
    private boolean updateWallpaper(String pkgName) {
        ...
        if (HOLO_DEFAULT.equals(pkgName)) {
            ...
            InputStream in = null;
            try {
                Context themeContext = mContext.createPackageContext(pkgName, Context.CONTEXT_IGNORE_SECURITY);
