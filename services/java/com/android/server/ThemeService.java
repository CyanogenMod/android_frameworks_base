...
public class ThemeService extends IThemeService.Stub {
    ...
    private boolean updateConfiguration(List<String> components) {
        ...
        if (am != null) {
            ...
            try {
                ...
                ThemeConfiguration.Builder themeBuilder = createBuilderFrom(config, components);
    ...
    private ThemeConfiguration.Builder createBuilderFrom(Configuration config, List<String> components) {
        ThemeConfiguration.Builder builder = new ThemeConfiguration.Builder(config.customTheme);
