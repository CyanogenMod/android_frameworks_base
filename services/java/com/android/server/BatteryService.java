    ...
    class Led {
        ...
        void updateLightsLocked() {
            ...
            if (!mLightEnabled || (inQuietHours() && mQuietHoursDim)) {
                // No lights if explicitly disabled or in quiet hours
    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            ...
            mBatteryLowARGB = Settings.System.getInt(resolver,
                    Settings.System.BATTERY_LIGHT_LOW_COLOR, Color.RED);
            mBatteryMediumARGB = Settings.System.getInt(resolver,
                    Settings.System.BATTERY_LIGHT_MEDIUM_COLOR, Color.YELLOW);
            mBatteryFullARGB = Settings.System.getInt(resolver,
                    Settings.System.BATTERY_LIGHT_FULL_COLOR, Color.GREEN);
