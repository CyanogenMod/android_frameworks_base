...
public class UsbDeviceManager {
    ...
    public void systemReady() {
        ...
        mUsbAudioEnabled = ((Settings.Global.getInt(mContentResolver, Settings.Global.USB_AUDIO_ENABLED, 0 ) == 1) ? true : false);
    ...
    private final class UsbHandler extends Handler {
        ...
        public UsbHandler(Looper looper) {
            ...
            try {
                ...
                mContentResolver.registerContentObserver(
                        Settings.Global.getUriFor(Settings.Global.USB_AUDIO_ENABLED),
                                false, new ContentObserver(null) {
                            public void onChange(boolean selfChange) {
                                mUsbAudioEnabled = (Settings.Global.getInt(mContentResolver,
                                    Settings.Global.USB_AUDIO_ENABLED, 0) > 0);
                            }
                        }
                );
