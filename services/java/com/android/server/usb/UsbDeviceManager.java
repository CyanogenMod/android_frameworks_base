...
public class UsbDeviceManager {
    ...
    private final class UsbHandler extends Handler {
        ...
        private void updateAdbNotification() {
            ...
            final int id_usb = com.android.internal.R.string.adb_active_notification_title;
            ...
            if ((mAdbEnabled && mConnected)
             && Settings.Secure.getInt(mContext.getContentResolver(),
                ...
                if (!mAdbNotificationShown) {
                    ...
                    Resources r = mContext.getResources();
                    CharSequence title = r.getText(id_all);
                    CharSequence message = r.getText(
                            com.android.internal.R.string.adb_both_active_notification_message);
                ...
                if (!mAdbNotificationShown) {
                    ...
                    Resources r = mContext.getResources();
                    CharSequence title = r.getText(id_usb);
                    CharSequence message = r.getText(
