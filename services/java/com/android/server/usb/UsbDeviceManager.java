...
public class UsbDeviceManager {
    ...
    public void systemReady() {
        ...
        // unless persist.sys.usb.config is set to mtp,adb. This will allow the USB notificaiton
        // to show on devices with mtp as primary, so the user can choose between mtp, ptp,
        // and mass storage. The legacy mass storage UI will be used otherwise.
