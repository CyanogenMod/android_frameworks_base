            ...
            if (usbAdbActive || netAdbActive) {
                ...
                if (!mAdbNotificationShown || mAdbNotificationIsForNetwork != netAdbActive
                 || mAdbNotificationIsForUSB != usbAdbActive) {
                    ...
                    int titleResId = 0;
                    if (usbAdbActive && netAdbActive) {
                        titleResId = com.android.internal.R.string.adb_both_active_notification_title;
                    } else if (usbAdbActive) {
                        titleResId = com.android.internal.R.string.adb_usb_active_notification_title;
                    } else if (netAdbActive) {
                        titleResId = com.android.internal.R.string.adb_net_active_notification_title;
                    } 
