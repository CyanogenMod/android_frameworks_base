...
final class DisplayPowerController {
    ...
    public DisplayPowerController(Looper looper, Context context, Notifier notifier,
        ...
        if (mUseSoftwareAutoBrightnessConfig) {
            ...
            cr.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.CUSTOM_AUTO_BRIGHTNESS),
    ...
    private void updateAutomaticBrightnessSettings() {
        ...
        if (Settings.System.getInt(mContext.getContentResolver(),
                    Settings.System.CUSTOM_AUTO_BRIGHTNESS, 0) != 0) {
            lux = getIntArrayForSetting(Settings.System.AUTO_BRIGHTNESS_LUX);
            values = getIntArrayForSetting(Settings.System.AUTO_BRIGHTNESS_BACKLIGHT);
        }
