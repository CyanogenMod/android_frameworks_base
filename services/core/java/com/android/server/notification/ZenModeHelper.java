...
public class ZenModeHelper {
    ...
    public void readLightsAllowedModeFromSetting() {
        if (mZenMode == Global.ZEN_MODE_NO_INTERRUPTIONS || mZenMode == Global.ZEN_MODE_ALARMS) {
            mAllowLights = mContext.getResources().getBoolean(R.bool.config_zen_allow_lights);
            ...
            mAllowLights = CMSettings.System.getInt(mContext.getContentResolver(),
                   CMSettings.System.ALLOW_LIGHTS, 1) == 1;
        } else {
            mAllowLights = true;
        }
    }
    ...
    private final class SettingsObserver extends ContentObserver {
        ...
        private final Uri ALLOW_LIGHTS = CMSettings.System.getUriFor(CMSettings.System.ALLOW_LIGHTS);
