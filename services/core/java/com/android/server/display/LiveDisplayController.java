...
public class LiveDisplayController {
    ...
    private final float mDefaultOutdoorLux;
    ...
    LiveDisplayController(Context context, Looper looper) {
        ...
        mDefaultOutdoorLux = Float.valueOf(mContext.getResources().getString(
                com.android.internal.R.string.config_outdoorAmbientLux));
