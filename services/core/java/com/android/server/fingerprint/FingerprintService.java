...
public class FingerprintService extends SystemService {
    ...
    public List<Fingerprint> getEnrolledFingerprints(IBinder token, int userId) {
        ...
        List<Fingerprint> nativeFingerprints = Arrays.asList(nativeFingerprintsArray);
    ...
    private final class FingerprintServiceWrapper extends IFingerprintService.Stub {
        ...
        private void dumpAddFinger(PrintWriter pw, String[] args) {
            ...
            FingerprintUtils.addFingerprintIdForUser(id, getContext(), getCurrentUserId());
        }
        ...
        private void dumpCommandList(PrintWriter pw) {
            ...
            pw.println(DUMP_CMD_ADD_FINGER + " [id] [name] - Add a fingerprint to enrollment");
