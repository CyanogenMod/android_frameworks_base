...
public class ThemeService extends IThemeService.Stub {
    ...
    public void systemRunning() {
        ...
        IntentFilter filter = new IntentFilter(RingtoneManager.ACTION_ALARMS_CHANGED);
        mContext.registerReceiver(mAlarmsChangeReceiver, filter);
        IntentFilter filter = new IntentFilter(RingtoneManager.ACTION_NOTIFICATIONS_CHANGED);
        mContext.registerReceiver(mNotificationsChangeReceiver, filter);
        IntentFilter filter = new IntentFilter(RingtoneManager.ACTION_RINGTONES_CHANGED);
    ...
    private BroadcastReceiver mAlarmsChangeReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            Log.d(TAG, "onReceive ACTION_ALARMS_CHANGE");
    ...
    private BroadcastReceiver mNotificationsChangeReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            Log.d(TAG, "onReceive ACTION_NOTIFICATIONS_CHANGE");
    ...
    private BroadcastReceiver mRingtonesChangeReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            Log.d(TAG, "onReceive ACTION_RINGTONES_CHANGE");
