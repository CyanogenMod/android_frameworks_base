...
public final class BatteryService extends SystemService {
    ...
    private int mLastBatteryChargeType;
    ...
    private void processValuesLocked(boolean force) {
        ...
        if (DEBUG) {
            ...
            msg +=  ", chargerUsbOnline=" + mBatteryProps.chargerUsbOnline
                    ...
                    + ", batteryChargeType=" + mBatteryProps.batteryChargeType
        ...
        final boolean batteryChanged = mBatteryProps.batteryStatus != mLastBatteryStatus ||
                mBatteryProps.batteryChargeType != mLastBatteryChargeType ||
        ...
        if (force || batteryChanged || dockBatteryChanged ||
            ...
            mLastBatteryChargeType = mBatteryProps.batteryChargeType;
    ...
    private void sendIntentLocked() {
        ...
        if (DEBUG) {
            String msg = "Sending ACTION_BATTERY_CHANGED. level:" + mBatteryProps.batteryLevel +
                    ...
                    ", charge_type:" + mBatteryProps.batteryChargeType +
