...
public final class BatteryService extends SystemService {
    ...
    private final class Led {
        ...
        public Led(Context context, LightsManager lights) {
            ...
            mMultiColorLed = nm.doLightsSupport(NotificationManager.LIGHTS_RGB_LED);
            ...
            mMultipleNotificationLeds = nm.doLightsSupport(NotificationManager.LIGHTS_MULTIPLE_LED);
            ...
            mUseSegmentedBatteryLed = nm.doLightsSupport(NotificationManager.LIGHTS_SEGMENTED_LED);
        }
