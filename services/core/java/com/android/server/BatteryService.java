...
public final class BatteryService extends SystemService {
    ...
    private final class Led {
        ...
        public Led(Context context, LightsManager lights) {
            ...
            mBrightnessNotificationLed = context.getResources().getBoolean(
        ...
        public void updateLightsLocked() {
            ...
            if (!mLightEnabled) {
                ...
                mBatteryLight.setModes(mBrightnessLevelNotificationLed,
    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            ...
            // Notification LED brightness
            if (mBrightnessNotificationLed) {
                 mBrightnessLevelNotificationLed = Settings.System.getInt(resolver,
                        Settings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL,
