...
public class FontListParser {
    ...
    /* Parse fallback list (no names) */
    public static Config parse(InputStream in, File fontDir)
            throws XmlPullParserException, IOException {
        ...
        try {
            ...
            if (isLegacyFormat(bis)) {
                return parseLegacyFormat(bis, fontDir.getAbsolutePath());
            } else {
                return parseNormalFormat(bis, fontDir.getAbsolutePath());
            }
        } finally {
