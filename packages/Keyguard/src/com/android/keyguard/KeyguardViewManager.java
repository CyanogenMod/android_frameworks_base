...
public class KeyguardViewManager {
    ...
    public static final String ACTION_USER_LOCKSCREEN_SETTINGS_CHANGED =
            "com.android.keyguard.action.USER_LOCKSCREEN_SETTINGS_CHANGED";
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (ACTION_USER_LOCKSCREEN_SETTINGS_CHANGED.equals(intent.getAction())) {
    ...
    public KeyguardViewManager(Context context, ViewManager viewManager,
        ...
        context.registerReceiver(mBroadcastReceiver, new IntentFilter(ACTION_USER_LOCKSCREEN_SETTINGS_CHANGED));
    }
            ...
            switch (mBackgroundStyle) {
                ...
                case LOCKSCREEN_STYLE_IMAGE:
                    try {
                        ...
                        userDrawable.setColorFilter(BACKGROUND_COLOR, PorterDuff.Mode.SRC_OVER);
                        userDrawable.setAlpha((int) (mWallpaperAlpha * 255));
