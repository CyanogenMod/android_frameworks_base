...
public class KeyguardViewManager {
    ...
    class ViewManagerHost extends FrameLayout {
        ...
        private void cacheUserImage() {
            ...
            int backgroundStyle = mLockscreenStyle = Settings.System.getInt(
        ...
        public boolean shouldShowWallpaper() {
            // if the style is a color, it's probably got some alpha
            return mLockscreenStyle == LOCKSCREEN_STYLE_DEFAULT
                    || mLockscreenStyle == LOCKSCREEN_STYLE_COLOR;
        }
    ...
    public synchronized void onScreenTurnedOn(final IKeyguardShowCallback callback) {
        ...
        if (mKeyguardView != null) {
            ...
            updateShowWallpaper(true); // assume we always show it
