...
public class SearchPanelCircleView extends FrameLayout {
    ...
    private void updateCircleRect() {
        ...
        int newLeft = (mCircleRectLeft.left / 2) - (mCircleRectLeft.width() / 2);
        int newTop = mCircleRectLeft.bottom - (mCircleRectLeft.height() / 2);
        mCircleRectLeft.offsetTo(newLeft, newTop);

        mCircleRectRight.set(mCircleRectLeft);
        mCircleRectRight.right = getWidth() - mCircleRectRight.left;
        mCircleRectRight.left = mCircleRectRight.right - mCircleRectLeft.width();
    }
