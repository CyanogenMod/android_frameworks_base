...
public class BrightnessQuickSettings extends CustomQuickSettings implements BrightnessStateChangeCallback {
    ...
    public BrightnessQuickSettings(Context context, LayoutInflater inflater,
            QuickSettingsContainerView container, final CustomQuickSettingsController qsc, Handler handler) {
