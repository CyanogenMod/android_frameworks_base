...
public class CompassTile extends QuickSettingsTile implements SensorEventListener {
    ...
    final float DEFAULT_IMAGE_ROTATION = 90;
    final int ANIMATION_DURATION = 200;

    private SensorManager mSensorManager;
    private Sensor mOrientation;

    private RelativeLayout cardinalDirections;
    private ImageView image;
    private TextView text;

    public CompassTile(Context context, QuickSettingsController qsc) {
        super(context, qsc, R.layout.quick_settings_tile_compass);
    ...
    void onPostCreate() {
        ...
        cardinalDirections = (RelativeLayout) mTile.findViewById(R.id.cardinalDirections);
    ...
    private synchronized void updateTile() {
        if (mActive) {
            cardinalDirections.setVisibility(View.VISIBLE);
            ...
            cardinalDirections.setVisibility(View.GONE);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        degree = (mActive) ? degree + DEFAULT_IMAGE_ROTATION : 0;
