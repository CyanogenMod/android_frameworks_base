...
public class AutoRotateQuickSettings extends CustomQuickSettings {

    private boolean enabled = false;
    private ContentObserver mContentObserver;
    private static final String TAG = "AutoRotateButton";

    public AutoRotateQuickSettings(Context context, LayoutInflater inflater,
            QuickSettingsContainerView container, CustomQuickSettingsController qsc, Handler handler) {
