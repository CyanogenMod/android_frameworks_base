...
public class RingerVibrationModeTile extends QuickSettingsTile {
    ...
    private final Ringer mSilentRinger = new Ringer(AudioManager.RINGER_MODE_SILENT, false, false);
    private final Ringer mVibrateRinger = new Ringer(AudioManager.RINGER_MODE_VIBRATE, true, true);
    private final Ringer mSoundRinger = new Ringer(AudioManager.RINGER_MODE_NORMAL, false, true);
    private final Ringer mSoundVibrateRinger = new Ringer(AudioManager.RINGER_MODE_NORMAL, true, true);
    ...
    private void findCurrentState() {
        ...
        Ringer ringer = new Ringer(ringerMode, vibrateWhenRinging, vibrateInSilent);
    ...
    private class Ringer {
        ...
        Ringer( int ringerMode, boolean vibrateWhenRinging, boolean vibrateInSilent) {
        ...
        public boolean equals(Object o) {
            ...
            return r.mVibrateInSilent == mVibrateInSilent
                    && r.mVibrateWhenRinging == mVibrateWhenRinging
