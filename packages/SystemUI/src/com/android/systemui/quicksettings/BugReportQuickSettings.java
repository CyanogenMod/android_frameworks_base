...
public class BugReportQuickSettings extends CustomQuickSettings{

    private boolean enabled = false;
    private final Handler mHandler;

    public BugReportQuickSettings(Context context, LayoutInflater inflater,
            QuickSettingsContainerView container,
            CustomQuickSettingsController qsc, Handler handler) {
        super(context, inflater, container, qsc);

        mHandler = handler;
        mLabel = mContext.getString(R.string.quick_settings_report_bug);
        mDrawable = R.drawable.ic_qs_adb;
