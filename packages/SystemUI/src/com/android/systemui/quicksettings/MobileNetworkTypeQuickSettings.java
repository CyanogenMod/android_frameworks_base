...
public class MobileNetworkTypeQuickSettings extends CustomQuickSettings {
 ...
 // retrieved from Phone.apk
    ...
    public MobileNetworkTypeQuickSettings(Context context,
            LayoutInflater inflater, QuickSettingsContainerView container,
            CustomQuickSettingsController qsc) {
