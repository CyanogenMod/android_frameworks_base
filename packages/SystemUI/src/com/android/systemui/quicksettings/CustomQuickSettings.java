...
public class CustomQuickSettings {
    ...
    protected CustomQuickSettingsController mQsc;

    public CustomQuickSettings(Context context, LayoutInflater inflater, QuickSettingsContainerView container, CustomQuickSettingsController qsc) {
        mContext = context;
