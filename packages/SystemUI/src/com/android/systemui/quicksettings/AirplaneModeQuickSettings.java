...
public class AirplaneModeQuickSettings extends CustomQuickSettings implements NetworkSignalChangedCallback{

    private boolean enabled = false;

    public AirplaneModeQuickSettings(Context context, LayoutInflater inflater,
