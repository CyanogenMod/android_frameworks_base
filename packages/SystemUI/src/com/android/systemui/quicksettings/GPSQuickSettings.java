...
public class GPSQuickSettings extends CustomQuickSettings implements LocationGpsStateChangeCallback {
    ...
    public GPSQuickSettings(Context context, LayoutInflater inflater,
