...
public class BluetoothQuickSettings extends CustomQuickSettings implements BluetoothStateChangeCallback{

    private boolean enabled = false;
    private boolean connected = false;
    private BluetoothAdapter mBluetoothAdapter;

    public BluetoothQuickSettings(Context context, LayoutInflater inflater,
