...
public class RingerVibrationQuickSettings extends CustomQuickSettings {

    private AudioManager mAudioManager;

    public RingerVibrationQuickSettings(Context context, LayoutInflater inflater,
        ...
        onClick = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mAudioManager.getRingerMode() == AudioManager.RINGER_MODE_NORMAL && vibrate){
                    ...
                    Intent i = new Intent(VibrationQuickSettings.VIBRATION_STATE_CHANGED);
        ...
        mIntentFilter.addAction(VibrationQuickSettings.VIBRATION_STATE_CHANGED);
    }
