...
public class EqualizerTile extends QuickSettingsTile {
    ...
    void onPostCreate() {
        ...
        if (mVisualizer != null) {
            ...
            paint.setStrokeWidth(mContext.getResources().getDimensionPixelSize(R.dimen.eqalizer_path_stroke_width));
            ...
            mVisualizer.addRenderer(new BarGraphRenderer(
                    mContext.getResources().getInteger(R.integer.equalizer_divisions), paint, false));
        }
