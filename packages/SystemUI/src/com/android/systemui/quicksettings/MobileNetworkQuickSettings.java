...
public class MobileNetworkQuickSettings extends CustomQuickSettings implements NetworkSignalChangedCallback{
    ...
    public MobileNetworkQuickSettings(Context context, LayoutInflater inflater,
