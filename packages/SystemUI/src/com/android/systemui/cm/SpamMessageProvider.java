...
public class SpamMessageProvider extends ContentProvider {
    ...
    private static final String UPDATE_COUNT_QUERY = "UPDATE %s SET %s=%s,%s=%s+1 WHERE %s='%s'";
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        case MESSAGE_UPDATE_COUNT:
            String formattedQuery = String.format(UPDATE_COUNT_QUERY, NotificationTable.TABLE_NAME,
                    NotificationTable.LAST_BLOCKED, System.currentTimeMillis(),
                    NotificationTable.COUNT, NotificationTable.COUNT,
                    NotificationTable.ID, uri.getLastPathSegment());
