...
public class CMCaseView extends DessertCaseView {
    ...
    private static final int[] XRARE_PASTRIES = {
            R.drawable.dessert_cid_wat,
            R.drawable.cm_cid_skate,
    ...
    public CidCaseView(Context context) {
        super(context, null);
    }

    public CidCaseView(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
    }

    public CidCaseView(Context context, AttributeSet attrs, int defStyle) {
