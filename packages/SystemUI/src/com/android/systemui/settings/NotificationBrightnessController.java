...
public class NotificationBrightnessController implements ToggleSlider.Listener {
    ...
    public static final int LIGHT_BRIGHTNESS_MAXIMUM = 100;
    ...
    public void onChanged(ToggleSlider view, boolean tracking, boolean automatic, int value) {
        ...
        final int val = value + mMinimumBrightness;

        if (!tracking) {
            AsyncTask.execute(new Runnable() {
                    public void run() {
                        Settings.System.putIntForUser(mContext.getContentResolver(),
                                Settings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL, val,
    ...
    private void updateSlider() {
        ...
        mControl.setValue(value - mMinimumBrightness);
        updateNotification();
    }
    ...
    private void updateNotification() {
        if (mNotificationAllow) {
            ...
            mNotificationColor = (mNotificationColor == 0xFFFFFF ? 0xFEFEFE : 0xFFFFFF);
            mNotificationBuilder.setLights(mNotificationColor, 1, 0);
