...
public class AvdBatteryMeterView extends BatteryMeterView implements DemoMode,
    ...
    protected class CircleBatteryMeterDrawable extends StopMotionVectorDrawable
        ...
        public CircleBatteryMeterDrawable(Resources res) {
            super(null);
            mBatteryDrawable =
                    (LayerDrawable) getContext().getDrawable(R.drawable.ic_battery_circle);
            mBoltDrawable = mBatteryDrawable.findDrawableByLayerId(R.id.battery_charge_indicator);
            setDrawable(mBatteryDrawable.findDrawableByLayerId(R.id.battery_fill));
            mDisposed = false;
