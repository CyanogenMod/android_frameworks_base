...
public class BatteryMeterView extends View implements DemoMode,
    ...
    public static final String TAG = "BatteryMeterView";
    ...
    private class BatteryTracker extends BroadcastReceiver {
        ...
        Log.v(TAG, "public void onReceive(Context context, Intent intent)");
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                //    }
                //}
                Log.v(TAG, "onReceive.postInvalidate()");
                postInvalidate();
    ...
    public BatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        Log.v(TAG, "public BatteryMeterView(Context context, AttributeSet attrs, int defStyle)");
        ...
        atts.recycle();
        mShowPercent = ENABLE_PERCENT && 1 == Settings.System.getInt(
                context.getContentResolver(), STATUS_BAR_BATTERY_STYLE_SHOW_PERCENT, 0);
