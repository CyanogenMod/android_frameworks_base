...
public class SearchPanelView extends FrameLayout implements StatusBarPanel,
    ...
    private void startExitAnimation() {
        ...
        mLaunching = true;
        if (!mActionTarget.launchAction(mTargetActivities[mCircle.mIntersect])) {
            startAssistActivity();
        }
        vibrate();
        mCircle.setAnimatingOut(true);
    ...
    private void updateTargetVisibility() {
        for (ImageView v : mTargetViews) {
            ...
            parent.setVisibility((mInEditMode || background != null) ? View.VISIBLE : View.GONE);
        }
    }
