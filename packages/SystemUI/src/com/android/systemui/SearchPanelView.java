...
public class SearchPanelView extends FrameLayout implements
    ...
    private TargetDrawable getTargetDrawable (String action) {
        TargetDrawable cDrawable = new TargetDrawable(mResources, mResources.getDrawable(com.android.internal.R.drawable.ic_navigation_ring_blank));
        cDrawable.setEnabled(false);

        if (action == null || action.equals("") || action.equals(ACTION_NONE)) {
            return cDrawable;
        } else if (action.equals(ACTION_SCREENSHOT)) {
            return new TargetDrawable(mResources, mResources.getDrawable(com.android.internal.R.drawable.ic_action_screenshot));
        } else if (action.equals(ACTION_IME)) {
            return new TargetDrawable(mResources, mResources.getDrawable(com.android.internal.R.drawable.ic_action_ime_switcher));
        } else if (action.equals(ACTION_VIBRATE)) {
            return new TargetDrawable(mResources, mResources.getDrawable(com.android.internal.R.drawable.ic_action_vibrate));
        } else if (action.equals(ACTION_SILENT)) {
            return new TargetDrawable(mResources, mResources.getDrawable(com.android.internal.R.drawable.ic_action_silent));
        } else if (action.equals(ACTION_RING_SILENT_VIBRATE)) {
            return new TargetDrawable(mResources, mResources.getDrawable(com.android.internal.R.drawable.ic_action_ring_vibrate_silent));
        } else if (action.equals(ACTION_KILL)) {
            return new TargetDrawable(mResources, mResources.getDrawable(com.android.internal.R.drawable.ic_action_killtask));
        } else if (action.equals(ACTION_POWER)) {
            return new TargetDrawable(mResources, mResources.getDrawable(com.android.internal.R.drawable.ic_action_power));
            ...
            try {
                ...
                Drawable iconBg = mResources.getDrawable(com.android.internal.R.drawable.ic_navigation_ring_blank);
                Drawable iconBgActivated = mResources.getDrawable(com.android.internal.R.drawable.ic_navigation_ring_blank_activated);
