...
public class SwipeHelper implements Gefingerpoken {
    ...
    private float mInitialTouchPosAlt;
    ...
    private float getAltPos(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mCurrView != null) {
                    ...
                    mInitialTouchPosAlt = getAltPos(ev);
            ...
            case MotionEvent.ACTION_MOVE:
                if (mCurrView != null) {
                    ...
                    if (mSwipeDirection == X) {
                        ...
                        if ((mSwipeZone & SWIPE_ZONE_TOP) == 0 && altPos < mInitialTouchPosAlt) {
                            touchBeyondZoneLimit = false;
