...
public class QSPanel extends ViewGroup {
    ...
    private boolean mHideQsTilesWithSensibleData;
    ...
    public void refreshAllTiles() {
        ...
        for (int i = 0; i < mRecords.size(); i++) {
            ...
            boolean hideTilesWithSensitiveData = mHideQsTilesWithSensibleData
                    && mHost != null
    ...
    public void setHideQsTilesWithSensibleData(boolean value) {
        mHideQsTilesWithSensibleData = value;
    }
