...
public class CameraTile extends QSTile<QSTile.BooleanState>{
    ...
    public CameraTile(Host host) {
        ...
        mHandler  = new Handler(host.getLooper().getMainLooper()); //ui thread
    }
    ...
    protected void handleLongClick() {
        mHost.startSettingsActivity(MEDIA_INTENT);
    }
    ...
    private final class CameraDetailAdapter implements DetailAdapter, QSDetailItems.Callback,
            TextureView.SurfaceTextureListener, Camera.PreviewCallback, View.OnClickListener {
        ...
        private Runnable mStartRunnable = new Runnable() {
            ...
            public void run() {
                ...
                // Get optimal sizes
                mCameraSize = getOptimalPreviewSize(mParams.getSupportedPictureSizes(),
                        ((ViewGroup) mRootView.getParent()).getWidth(),
                        ((ViewGroup) mRootView.getParent()).getHeight());
                mParams.setPictureSize(mCameraSize.width, mCameraSize.height);
                Camera.Size previewSize = getOptimalPreviewSize(mParams.getSupportedPreviewSizes(),
                        ((ViewGroup) mRootView.getParent()).getWidth(),
                        ((ViewGroup) mRootView.getParent()).getHeight());
                ...
                mTextureView.setOnClickListener(CameraDetailAdapter.this);
        ...
        private Camera.Size getOptimalPreviewSize(List<Camera.Size> sizes, int w, int h) {
            System.out.println("Original Preview Size width " + w + " and height " + h);
            ...
            System.out.println("Optimal Size width " + optimalSize.width + " height " + optimalSize.height);
            return optimalSize;
        }
    }
}
