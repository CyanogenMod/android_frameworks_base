...
public class LiveDisplayTile extends QSTile<LiveDisplayTile.LiveDisplayState> {
    ...
    public LiveDisplayTile(Host host) {
        ...
        mOutdoorModeAvailable = mLiveDisplay.hasFeature(MODE_OUTDOOR) &&
                !mLiveDisplay.hasFeature(FEATURE_MANAGED_OUTDOOR_MODE);

        mDayTemperature = mLiveDisplay.getDayTemperature();
    ...
    private void changeToNextMode() {
        ...
        mLiveDisplay.setMode(Integer.valueOf(mValues[next]));
    }
