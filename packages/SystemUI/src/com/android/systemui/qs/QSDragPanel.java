...
public class QSDragPanel extends QSPanel implements View.OnDragListener, View.OnLongClickListener {
    ...
    private static final String BROADCAST_TILE_PLACEHOLDER = "broadcast_placeholder";
    ...
    protected void showAddDialog() {
        ...
        for (String tileSpec : currentTileSpec) {
            availableTilesSpec.remove(tileSpec);
        }
        ...
        availableTilesSpec.add(BROADCAST_TILE_PLACEHOLDER);
        ...
        final AlertDialog d = new AlertDialog.Builder(getContext(), R.style.Theme_SystemUI_Dialog)
                ...
                .setItems(items, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (tileSpec.equals(BROADCAST_TILE_PLACEHOLDER)) {
