...
public class QSDragPanel extends QSPanel implements View.OnDragListener, View.OnLongClickListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isShowingDetail() && mPanelBottom - mTopOffset > mDisplaySize.y) {
            mDetail.measure(exactly(width), exactly(mMaxHeight - (mPanelBottom - mDisplaySize.y)));

        } else if (isShowingDetail()) {
            mDetail.measure(exactly(width), exactly(mGridHeight - mTopOffset));

        } else if (mDetail.getMeasuredHeight() < mMaxHeight) {
    ...
    protected void handleShowDetailTile(TileRecord r, boolean show) {
        ...
        mPanelView.setQsExpansionEnabled(!show);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mDetail.layout(0, mTopOffset, w, mDetail.getMeasuredHeight() + mTopOffset);
