    ...
    public static class TilesListAdapter extends BaseExpandableListAdapter
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
            ...
            if (qsTile instanceof CustomQSTile) {
                String dynamicLabel = QSUtils.getDynamicQSTileLabel(mContext, UserHandle.myUserId(),
                        ((CustomQSTile) qsTile).getTile().getKey());
                if (dynamicLabel == null) {
                    label = getPackageLabel(((CustomQSTile) qsTile).getTile().getPackage());
                } else {
                    label = dynamicLabel;
                }
            } else {
