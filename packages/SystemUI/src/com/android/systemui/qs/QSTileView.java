...
public class QSTileView extends ViewGroup {
    ...
    public boolean setDual(boolean dual) {
        Log.d(TAG, "setDual() called with " + "dual = [" + dual + "]");
    ...
    public void setEditing(boolean editing) {
        if (mDual) {
            if (mTopBackgroundView != null) {
                mTopBackgroundView.setOnLongClickListener(editing ? mLongClick : null);
            }
            if (mDualLabel != null) {
                mDualLabel.setFocusable(!editing);
                mDualLabel.setOnLongClickListener(editing ? mLongClick : null);
            }
        } else {
            if (mLabel != null) {
                mLabel.setClickable(!editing);
            }
        }
