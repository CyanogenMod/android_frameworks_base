...
public class QSTileView extends ViewGroup {
    ...
    public void setClickable(boolean clickable) {
        super.setClickable(clickable && !mDual);
        if (mLabel != null) {
            mLabel.setClickable(clickable && !mDual);
        }
        if (mDualLabel != null) {
            mDualLabel.setClickable(clickable && mDual);
        }
        if (mTopBackgroundView != null) {
            mTopBackgroundView.setClickable(clickable && mDual);
        }
    }
