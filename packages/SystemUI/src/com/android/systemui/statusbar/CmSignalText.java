...
public class CmSignalText extends TextView {
    ...
    public CmSignalText(Context context, AttributeSet attrs) {
        super(context, attrs);
        ((TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE)).listen(mPhoneStateListener,
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(Settings.System.STATUS_BAR_CM_SIGNAL_TEXT),
                    false, this);
        }
    ...
    protected final void updateSignalText() {
        if (Settings.System.getInt(mContext.getContentResolver(), Settings.System.STATUS_BAR_CM_SIGNAL_TEXT, 0) == 1) {
