...
public class SuControllerImpl implements SuController {
    ...
    private static final int[] mSuOpArray
    ...
    private boolean mAreActiveSuSessions;
    ...
    public SuControllerImpl(Context context) {
        ...
        intentFilter.addAction(Intent.ACTION_SU_SESSION_CHANGED);
        context.registerReceiverAsUser(new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
                Log.i(TAG, "Got change");
                String action = intent.getAction();
                if (Intent.ACTION_SU_SESSION_CHANGED.equals(action)) {
     ...
     */
    private boolean areActiveSuSessions() {
    ...
    private void updateActiveSuSessions() {
        boolean hadActiveSuSessions = mAreActiveSuSessions;
        mAreActiveSuSessions = areActiveSuSessions();
        if (mAreActiveSuSessions != hadActiveSuSessions) {
            fireCallbacks();
        }
    }
}
