...
public class BatteryController extends BroadcastReceiver {
    ...
    protected void updateViews(int level) {
        ...
        for (BatteryStateChangeCallback cb : mChangeCallbacks) {
            cb.onBatteryLevelChanged(level, isBatteryPlugged());
        }
    }
    ...
    protected void updateBattery() {
        ...
        if (isBatteryStatusUnknown()) {
            ...
            mIcon = (View.VISIBLE);
            mIconStyle = isBatteryPlugged() ? getIconStyleCharge() : getIconStyleNormal();
        } else if (mBatteryStyle == BATTERY_STYLE_PERCENT) {
            mIcon = (View.VISIBLE);
            mText = (View.VISIBLE);
            mIconStyle = isBatteryPlugged() ? getIconStyleChargeMin() : getIconStyleNormalMin();
        }
