...
public class NetworkController extends BroadcastReceiver implements DemoMode {
    ...
    void refreshViews() {
        ...
        if (mEthernetConnected) {
            mContentDescriptionEthernet = combinedLabel = mContext.getString(R.string.ethernet_label);
        }
    ...
    public void dispatchDemoCommand(String command, Bundle args) {
        if (!mDemoMode && command.equals(COMMAND_ENTER)) {
            ...
            if (ethernet != null) {
                ...
                for (SignalCluster cluster : mSignalClusters) {
                    int mDemoEthernetIconId = (mDemoInetCondition == 1 ? R.drawable.stat_sys_ethernet_fully :
                                               R.drawable.stat_sys_ethernet);
