...
public class BackDropView extends FrameLayout {
    ...
    private boolean mHasActiveNotification = false;
    private boolean mKeyguardFadingAway = false;
    private int mColor;
    ...
    public void setHasActiveNotification(boolean active) {
        if (mHasActiveNotification != active) {
            mHasActiveNotification = active;
            checkStateChanged();
        }
    }

    public void setKeyguardFadingAway(boolean fadingAway) {
        if (mKeyguardFadingAway != fadingAway) {
    ...
    private void checkStateChanged() {
        if (mVisible && mPlaying && !mAnimating && !mTouching && !mPowerSaveMode
                && !mHasActiveNotification && !mKeyguardFadingAway) {
            mLinkVisualizer.run();
        } else {
