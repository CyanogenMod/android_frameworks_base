...
public class StatusBarService extends Service implements CommandQueue.Callbacks {
    ...
    private void updateLayout() {
        ...
        mNotificationLinearLayout.removeView(mOngoingTitle);
        mNotificationLinearLayout.removeView(mOngoingItems);
        mNotificationLinearLayout.removeView(mLatestTitle);
        mNotificationLinearLayout.removeView(mLatestItems);
        mNotificationLinearLayout.removeView(mCompactClearButton);
        mBottomNotificationLinearLayout.removeView(mOngoingTitle);
        mBottomNotificationLinearLayout.removeView(mOngoingItems);
        mBottomNotificationLinearLayout.removeView(mLatestTitle);
        mBottomNotificationLinearLayout.removeView(mLatestItems);
        mBottomNotificationLinearLayout.removeView(mCompactClearButton);
