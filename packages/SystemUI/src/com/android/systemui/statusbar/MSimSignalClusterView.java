...
public class MSimSignalClusterView
    ...
    public MSimSignalClusterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        Log.e("TextView","Initialising");
        mSimLabels = new TextView[mNumPhones];
        Log.e("TextView", "Initialised");
    ...
    protected void onDetachedFromWindow() {
        ...
        for (int i = 0; i < mNumPhones; i++) {
            ...
            Log.e("TextView", "Detached?");
            mSimLabels[i] = null;
            Log.e("TextView", "OMG YASSS");
        }
    ...
    private void updateMobile(int phoneId) {
        ...
        Log.e("TextView", "Setting text to sim to "+mSimLabelText[phoneId]+" phone ID is "+phoneId);
        Log.e("TextView", "Using the text of sim");
