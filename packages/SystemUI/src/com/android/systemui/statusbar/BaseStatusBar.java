...
public abstract class BaseStatusBar extends SystemUI implements
        ...
        return new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                try {
                    ...
                    Slog.e(TAG, "Failed looking up ApplicationInfo for " + packageNameF, e);
                }
                // protected apps don't get long click listener
                if (mAppInfo.protect) return false;
        ...
        public void onClick(View v) {
            ...
            if (mProtected) {
                ...
                mContext.registerReceiver(mProtectedAppReceiver,
                        new IntentFilter("com.android.settings.applications.LockPatternActivity.ACTION_BROADCAST_RESULT"));
                Intent protectedIntent = new Intent();
                protectedIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                protectedIntent.setClassName("com.android.settings",
                        "com.android.settings.applications.LockPatternActivity");
                protectedIntent.putExtra("broadcast_result", true);
    ...
    protected NotificationData.Entry createNotificationViews(IBinder key,
        ...
        final StatusBarIcon ic;
        if (protectedApp) {
            // we need to use the systemui's package name for the icon here
            ic = new StatusBarIcon(mContext.getPackageName(),
            ...
            ic = new StatusBarIcon(notification.getPackageName(),
                    notification.getUser(),
                    notification.getNotification().icon,
                    notification.getNotification().iconLevel,
                    notification.getNotification().number,
