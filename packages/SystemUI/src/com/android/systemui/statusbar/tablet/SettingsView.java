...
public class SettingsView extends LinearLayout implements View.OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        mBluetooth = new BluetoothController(context, (CompoundButton)findViewById(R.id.bluetooth_checkbox));
        mWifi = new WifiController(context,(CompoundButton)findViewById(R.id.wifi_checkbox));
