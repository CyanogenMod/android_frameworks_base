...
public class SignalClusterView
    ...
    public void setMobileDataIndicators(boolean visible, int strengthIcon,
            ...
            String typeContentDescription, boolean isTypeIconWide, int subId) {
        ...
        if (showMobileActivity()) {
            state.mDataActivityId = 0;
            state.mDataVisible = false;
        } else {
            state.mMobileActivityId = 0;
            state.mDataActivityId = activityIcon;
            state.mDataVisible = activityIcon != 0;
        }

        if (mStyle == STATUS_BAR_STYLE_CDMA_1X_COMBINED) {
            if (SubscriptionManager.getPhoneId(subId) == 0) {
                if (!state.isRoaming() && showDataAndVoice()) {
                    state.mMobileCdmaVisible = true;
                    state.mMobileCdma1xOnlyVisible = false;
                    state.mMobileStrengthId = 0;

                    state.mMobileCdma3gId = strengthIcon;
                    state.mMobileCdma1xId = getCdma2gId(state.mMobileCdma3gId);
                    if (isCdmaDataOnlyMode()) {
                        state.mMobileCdmaVisible = false;
                        state.mMobileCdma1xOnlyVisible = false;
                        state.mMobileStrengthId = convertMobileStrengthIcon(strengthIcon);
                    }
                } else if (show1xOnly() || state.isRoaming()) {
                    state.mMobileCdmaVisible = false;
                    state.mMobileCdma1xOnlyVisible = true;
                    state.mMobileStrengthId = 0;

                    if (state.mDataVisible && getCdmaRoamId(strengthIcon) != 0) {
                        state.mMobileCdma1xOnlyId = getCdmaRoamId(strengthIcon);
                    } else {
                        state.mMobileCdma1xOnlyId = strengthIcon;
                    }
                } else {
                    state.mMobileCdmaVisible = false;
                    state.mMobileCdma1xOnlyVisible = false;
                ...
                if (state.mDataVisible && getCdmaRoamId(state.mMobileStrengthId) != 0) {
                    state.mMobileStrengthId = getCdmaRoamId(state.mMobileStrengthId);
                }
            }
        } else if (mStyle == STATUS_BAR_STYLE_DATA_VOICE) {
            if (showBothDataAndVoice() && getMobileVoiceId() != 0) { // XXX: per sub
                state.mMobileStrengthId = 0;
                state.mMobileDataVoiceVisible = true;
                state.mMobileSignalDataId = strengthIcon;
                state.mMobileSignalVoiceId = getMobileVoiceId(); // XXX: per sub
            } else {
                state.mMobileStrengthId = convertMobileStrengthIcon(state.mMobileStrengthId);
                state.mMobileDataVoiceVisible = false;
            }
        } else {
            state.mMobileCdmaVisible = false;
            state.mMobileCdma1xOnlyVisible = false;
    ...
    private boolean showBothDataAndVoice() {
        ...
        if (mNC.getVoiceNetworkType() != TelephonyManager.NETWORK_TYPE_GSM) {
            return false;
        }

        int dataType = mNC.getDataNetworkType();
        return dataType == TelephonyManager.NETWORK_TYPE_TD_SCDMA
    ...
    private boolean isCdmaDataOnlyMode() {
        ...
        if (mNC.getVoiceNetworkType() != TelephonyManager.NETWORK_TYPE_UNKNOWN) {
            return false;
        }
    ...
    private boolean showDataAndVoice() {
        ...
        if (dataType == TelephonyManager.NETWORK_TYPE_EVDO_0
            ...
            if (voiceType == TelephonyManager.NETWORK_TYPE_GSM
    ...
    private boolean show1xOnly() {
        ...
        int dataType = mNC.getDataNetworkType();
        return dataType == TelephonyManager.NETWORK_TYPE_1xRTT
    ...
    private int getMobileVoiceId() {
        ...
        switch (mNC.getGsmSignalLevel()) {
            case SignalStrength.SIGNAL_STRENGTH_NONE_OR_UNKNOWN:
                return R.drawable.stat_sys_signal_0_gsm;
            case SignalStrength.SIGNAL_STRENGTH_POOR:
                return R.drawable.stat_sys_signal_1_gsm;
            case SignalStrength.SIGNAL_STRENGTH_MODERATE:
                return R.drawable.stat_sys_signal_2_gsm;
            case SignalStrength.SIGNAL_STRENGTH_GOOD:
                return R.drawable.stat_sys_signal_3_gsm;
            case SignalStrength.SIGNAL_STRENGTH_GREAT:
                return R.drawable.stat_sys_signal_4_gsm;
            default:
                break;
        }*/
        return 0;
    ...
    private int convertMobileStrengthIcon(int icon) {
        ...
        switch (icon) {
            case R.drawable.stat_sys_signal_0_3g:
                return R.drawable.stat_sys_signal_0_3g_default;
            case R.drawable.stat_sys_signal_0_4g:
                return R.drawable.stat_sys_signal_0_4g_default;
            case R.drawable.stat_sys_signal_1_3g:
                return R.drawable.stat_sys_signal_1_3g_default;
            case R.drawable.stat_sys_signal_1_4g:
                return R.drawable.stat_sys_signal_1_4g_default;
            case R.drawable.stat_sys_signal_2_3g:
                return R.drawable.stat_sys_signal_2_3g_default;
            case R.drawable.stat_sys_signal_2_4g:
                return R.drawable.stat_sys_signal_2_4g_default;
            case R.drawable.stat_sys_signal_3_3g:
                return R.drawable.stat_sys_signal_3_3g_default;
            case R.drawable.stat_sys_signal_3_4g:
                return R.drawable.stat_sys_signal_3_4g_default;
            case R.drawable.stat_sys_signal_4_3g:
                return R.drawable.stat_sys_signal_4_3g_default;
            case R.drawable.stat_sys_signal_4_4g:
                return R.drawable.stat_sys_signal_4_4g_default;
            case R.drawable.stat_sys_signal_0_3g_fully:
                return R.drawable.stat_sys_signal_0_3g_default_fully;
            case R.drawable.stat_sys_signal_0_4g_fully:
                return R.drawable.stat_sys_signal_0_4g_default_fully;
            case R.drawable.stat_sys_signal_1_3g_fully:
                return R.drawable.stat_sys_signal_1_3g_default_fully;
            case R.drawable.stat_sys_signal_1_4g_fully:
                return R.drawable.stat_sys_signal_1_4g_default_fully;
            case R.drawable.stat_sys_signal_2_3g_fully:
                return R.drawable.stat_sys_signal_2_3g_default_fully;
            case R.drawable.stat_sys_signal_2_4g_fully:
                return R.drawable.stat_sys_signal_2_4g_default_fully;
            case R.drawable.stat_sys_signal_3_3g_fully:
                return R.drawable.stat_sys_signal_3_3g_default_fully;
            case R.drawable.stat_sys_signal_3_4g_fully:
                return R.drawable.stat_sys_signal_3_4g_default_fully;
            case R.drawable.stat_sys_signal_4_3g_fully:
                return R.drawable.stat_sys_signal_4_3g_default_fully;
            case R.drawable.stat_sys_signal_4_4g_fully:
                return R.drawable.stat_sys_signal_4_4g_default_fully;
            default:
                break;
        }*/
        return icon;
    ...
    private int getCdmaRoamId(int icon) {
        ...
        switch (icon) {
            ...
            case R.drawable.stat_sys_signal_0_4g_default_roam:
                return R.drawable.stat_sys_signal_0_default_roam;
            ...
            case R.drawable.stat_sys_signal_1_4g_default_roam:
                return R.drawable.stat_sys_signal_1_default_roam;
            ...
            case R.drawable.stat_sys_signal_2_4g_default_roam:
                return R.drawable.stat_sys_signal_2_default_roam;
            ...
            case R.drawable.stat_sys_signal_3_4g_default_roam:
                return R.drawable.stat_sys_signal_3_default_roam;
            ...
            case R.drawable.stat_sys_signal_4_4g_default_roam:
                return R.drawable.stat_sys_signal_4_default_roam;
            ...
            case R.drawable.stat_sys_signal_0_4g_default_fully_roam:
                return R.drawable.stat_sys_signal_0_default_fully_roam;
            ...
            case R.drawable.stat_sys_signal_1_4g_default_fully_roam:
                return R.drawable.stat_sys_signal_1_default_fully_roam;
            ...
            case R.drawable.stat_sys_signal_2_4g_default_fully_roam:
                return R.drawable.stat_sys_signal_2_default_fully_roam;
            ...
            case R.drawable.stat_sys_signal_3_4g_default_fully_roam:
                return R.drawable.stat_sys_signal_3_default_fully_roam;
            ...
            case R.drawable.stat_sys_signal_4_4g_default_fully_roam:
                return R.drawable.stat_sys_signal_4_default_fully_roam;
            default:
                break;
        }*/
        return 0;
    ...
    private class PhoneState {
        ...
        private boolean mMobileDataVoiceVisible, mDataVisible;
        private int mMobileSignalDataId = 0, mMobileSignalVoiceId = 0;
        ...
        private ViewGroup mMobileGroup, mMobileDataVoiceGroup, mDataGroup;
        ...
        public void setViews(ViewGroup root) {
            mMobileGroup          = root;
            mMobileDataVoiceGroup = (ViewGroup) root.findViewById(R.id.mobile_data_voice);
            mDataGroup            = (ViewGroup) root.findViewById(R.id.data_combo);
            mMobile               = (ImageView) root.findViewById(R.id.mobile_signal);
            mMobileType           = (ImageView) root.findViewById(R.id.mobile_type);
            mMobileActivity       = (ImageView) root.findViewById(R.id.mobile_inout);
            mMobileSignalData     = (ImageView) root.findViewById(R.id.mobile_signal_data);
            mMobileSignalVoice    = (ImageView) root.findViewById(R.id.mobile_signal_voice);
            mDataActivity         = (ImageView) root.findViewById(R.id.data_inout);
            mMobileCdmaGroup      = (ViewGroup) root.findViewById(R.id.mobile_signal_cdma);
            mMobileCdma3g         = (ImageView) root.findViewById(R.id.mobile_signal_3g);
            mMobileCdma1x         = (ImageView) root.findViewById(R.id.mobile_signal_1x);
            mMobileCdma1xOnly     = (ImageView) root.findViewById(R.id.mobile_signal_1x_only);
        }
        public boolean apply(boolean isSecondaryIcon) {
            ...
            if (mMobileCdmaVisible && !mIsAirplaneMode) {
            ...
            if (mMobileCdma1xOnlyVisible && !mIsAirplaneMode) {
