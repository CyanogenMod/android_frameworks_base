...
public abstract class PanelView extends FrameLayout {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mCancelled) {
                    ...
                    if (mShowExpandHint) {
                        startUnlockHintAnimationFadeOutPhase(onAnimationFinished);
                    } else {
                        onAnimationFinished.run();
                        notifyBarPanelExpansionChanged();
                    }
     ...
     */
    private void startUnlockHintAnimationFadeOutPhase(final Runnable onAnimationFinished) {
        mKeyguardBottomArea.getIndicationView().animate()
                .alpha(0)
                .setDuration(ANIMATION_FADE_DURATION)
     ...
     * Fade in Lls hint
     */
    private void startLlsHintAnimationFadeInPhase(final Runnable onAnimationFinished) {
                ...
                .withEndAction(new Runnable() {
                    ...
                    public void run() {
                        if (mShowUnlockHint || mShowExpandHint) {
                            startLlsHintAnimationFadeOutPhase(onAnimationFinished);
                        } else {
                            onAnimationFinished.run();;
                        }
                    }
     ...
     * Fade out Lls hint
     */
    private void startLlsHintAnimationFadeOutPhase(final Runnable onAnimationFinished) {
        mKeyguardBottomArea.getIndicationView().animate()
                .alpha(0)
                .setDuration(ANIMATION_FADE_DURATION)
                .setStartDelay(HINT_DELAY_DURATION)
    ...
    protected void startScreenOnHintAnimation(boolean showSwipeLeftHint, boolean showUnlockHint,
        ...
        if (showSwipeLeftHint) {
            ...
            startLlsHintAnimationFadeInPhase(r);
        } else if (showUnlockHint) {
            mStatusBar.onUnlockHintStarted();
            startUnlockHintAnimationFadeInPhase(r);
