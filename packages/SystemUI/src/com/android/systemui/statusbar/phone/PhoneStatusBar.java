...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private boolean mClockCentered = false;
    LinearLayout mCenterClockContainer;
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mCenterClockContainer = (LinearLayout) mStatusBarView.findViewById(R.id.clock_center);
    ...
    private void updateClockLocation(){
        ...
        if(mClockCentered){
            mCenterClockContainer.addView(clock, 0, lp);
        } else {
            final LinearLayout batteryCluster = (LinearLayout)mStatusBarContents.findViewById(R.id.signal_battery_cluster);
            batteryCluster.addView(clock, batteryCluster.getChildCount() - 1, lp);
        }
    }
    ...
    private class MyTicker extends Ticker {
        ...
        public void tickerStarting() {
            ...
            mCenterClockContainer.setVisibility(View.GONE);
            mTickerView.setVisibility(View.VISIBLE);
            mTickerView.startAnimation(loadAnim(com.android.internal.R.anim.push_up_in, null));
            mStatusBarContents.startAnimation(loadAnim(com.android.internal.R.anim.push_up_out, null));
            mCenterClockContainer.startAnimation(loadAnim(com.android.internal.R.anim.push_up_out, null));
        }

        @Override
        public void tickerDone() {
            mStatusBarContents.setVisibility(View.VISIBLE);
            mCenterClockContainer.setVisibility(View.VISIBLE);
            mTickerView.setVisibility(View.GONE);
            mCenterClockContainer.startAnimation(loadAnim(com.android.internal.R.anim.push_down_in, null));
        ...
        public void tickerHalting() {
            ...
            mCenterClockContainer.setVisibility(View.VISIBLE);
            mTickerView.setVisibility(View.GONE);
            mCenterClockContainer.startAnimation(loadAnim(com.android.internal.R.anim.fade_in, null));
