...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private View.OnLongClickListener mRecentsLongPressListener = new View.OnLongClickListener() {
        ...
        public boolean onLongClick(View v) {
            ...
            final ResolveInfo launcherInfo = mContext.getPackageManager()
                    .resolveActivity(launcherIntent, 0);
                ...
                if (!packageName.equals(defaultHomePackage)
                    ...
                    try {
                        mWindowManagerService.overridePendingAppTransition(
                                mContext.getPackageName(), R.anim.last_app_in,
                                R.anim.last_app_out, null);
