    ...
    class SettingsObserver extends UserContentObserver {
        ...
        public void update() {
            ...
            if (oldClockView != mClockView) {
                ...
                if (oldClockLocation == Clock.STYLE_CLOCK_CENTER
                        || oldClockLocation == Clock.STYLE_CLOCK_LEFT) {
                    // base alpha
...
//                    updateCarrierLabelVisibility(false);
    ...
    private void animateStatusBarHide(final View v, boolean animate) {
        // TODO: Linus come back to this - switching users can sometimes still leave an invisible one
        // because there is an animation being tied and then a different user uses a different clock position
        v.animate().cancel();
        if (!animate) {
            v.setAlpha(0f);
