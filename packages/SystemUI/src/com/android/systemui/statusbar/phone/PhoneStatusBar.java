        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (action == MotionEvent.ACTION_MOVE) {
                if (mAnimatingReveal && y < minY) {
                    try {
                        //Based on code from daryelv (https://github.com/daryelv)
                        ...
                        if (brightnessControl){
                            final int maxBrightness = (int) Math.round(android.os.Power.BRIGHTNESS_ON);
                            final int minBrightness = mStatusBarView.getContext().getResources().getInteger(
                                ...
                                if (mLinger > 50) {
                                    ...
                                    if (!autoBrightness) {
                                        ...
                                        if (newBrightness < minBrightness) {
                                            ...
                                            newBrightness = (int) maxBrightness;
                                        }
                                        try {
