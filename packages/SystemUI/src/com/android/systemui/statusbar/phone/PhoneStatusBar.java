...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private int mCloseHandleUnderlap;
    ...
    private void setLabelMarginFromRibbonSize(TextView tv) {
        if (tv == null)
            return;
        MarginLayoutParams lp = (MarginLayoutParams) tv.getLayoutParams();
        lp.bottomMargin = mCloseHandleUnderlap;
    ...
    private void setCarrierLabelMargin() {
        setLabelMarginFromRibbonSize(mCarrierLabel);
        setLabelMarginFromRibbonSize(mSubsLabel);
    }
...
//            Log.d(TAG, "size=" + newIconSize + " padding=" + newIconHPadding);
        ...
        mCloseHandleUnderlap = res.getDimensionPixelSize(R.dimen.close_handle_underlap);
