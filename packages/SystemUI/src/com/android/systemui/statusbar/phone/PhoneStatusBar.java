...
public class PhoneStatusBar extends StatusBar {
    ...
    protected View makeStatusBarView() {
        ...
        mMaxBrightness = (int) Math.round(android.os.Power.BRIGHTNESS_ON);
                            ...
                            if (yVel < 50.0f) {
                                if (mLinger > 20) {
                                    ...
                                    if (!autoBrightness) {
                                        ...
                                        int newBrightness = (int) Math.round(((x/mScreenWidth) * mMaxBrightness));
                                        newBrightness = Math.min(newBrightness, mMaxBrightness);
