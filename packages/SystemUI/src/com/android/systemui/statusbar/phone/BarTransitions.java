...
public class BarTransitions {
    ...
    public BarTransitions(View view, int gradientResourceId, int opaqueColorResourceId, int semiTransparentColorResourceId) {
        mTag = "BarTransitions." + view.getClass().getSimpleName();
        mView = view;
        mBarBackground = new BarBackgroundDrawable(mView.getContext(), gradientResourceId, opaqueColorResourceId, semiTransparentColorResourceId);
        if (HIGH_END) {
    ...
    private static class BarBackgroundDrawable extends Drawable {
        ...
        private int mOpaqueDefault;
        private int mSemiTransparentDefault;
        private int mOpaque;
        ...
        public BarBackgroundDrawable(Context context, int gradientResourceId, int opaqueColorResourceId, int semiTransparentColorResourceId) {
            final Resources res = context.getResources();
            if (DEBUG_COLORS) {
                mOpaqueDefault = 0xff0000ff;
                mSemiTransparentDefault = 0x7f0000ff;
                mOpaque = 0xff0000ff;
                mSemiTransparent = 0x7f0000ff;
            } else {
                mOpaqueDefault = res.getColor(R.color.system_bar_background_opaque);
                mSemiTransparentDefault = res.getColor(R.color.system_bar_background_semi_transparent);
        ...
        public void draw(Canvas canvas) {
            ...
            if (mMode == MODE_TRANSLUCENT) {
                ...
                targetColor = mSemiTransparent == 0x66000000 ? (mSemiTransparentDefault == 0x66000000 ? 0x66000000 : mSemiTransparentDefault) : mSemiTransparent;
            } else if (mMode == MODE_TRANSPARENT) {
                targetGradientAlpha = 0;
            } else {
                targetColor = mOpaque == 0xff000000 ? (mOpaqueDefault == 0xff000000 ? 0xff000000 : mOpaqueDefault) : mOpaque;
            }
            if (!mAnimating) {
                mColor = targetColor;
