...
public class NotificationPanelView extends PanelView implements
    ...
    protected void onFinishInflate() {
        ...
        mKeyguardWeatherEnabled = CMSettings.Secure.getInt(getContext().getContentResolver(),
                CMSettings.Secure.LOCK_SCREEN_WEATHER_ENABLED, 0) == 1;
        mKeyguardWeatherInfo.setVisibility(mKeyguardWeatherEnabled ? VISIBLE : GONE);
    }
    ...
    public void onWeatherChanged(WeatherController.WeatherInfo info) {
        if (!mKeyguardWeatherEnabled) return;
