...
public class StatusBarKeyguardViewManager {
    ...
    private void showBouncerOrKeyguard(boolean isBackPressed) {
        switch (mBouncer.needsFullscreenBouncer()) {
            case KeyguardBouncer.LockscreenStagePriority.FORCE_BOUNCER:
                // SIM PIN/PUK
                // The keyguard might be showing (already). So we need to hide it.
                mPhoneStatusBar.hideKeyguard();
                mBouncer.show(true /* resetSecuritySelection */);
                break;
            case KeyguardBouncer.LockscreenStagePriority.BOUNCER_FIRST:
                ...
                break;
            case KeyguardBouncer.LockscreenStagePriority.DEFAULT:
                mPhoneStatusBar.showKeyguard();
                mBouncer.hide(false /* destroyView */);
                mBouncer.prepare();
                break;
    ...
    private void updateStates() {
        ...
        boolean bouncerDismissible = (mBouncer.isFullscreenBouncer() !=
                KeyguardBouncer.LockscreenStagePriority.FORCE_BOUNCER);
