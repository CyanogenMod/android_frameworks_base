...
public class PhoneStatusBarView extends PanelBar {
    ...
    public void onAllPanelsCollapsed() {
        ...
        mBar.updatePieTriggerMask(Position.LEFT.FLAG | Position.TOP.FLAG | Position.RIGHT.FLAG | Position.TOP.FLAG);
    }
    ...
    public void onPanelFullyOpened(PanelView openPanel) {
        ...
        if (mShouldFade)
            mBar.updatePieTriggerMask(Position.LEFT.FLAG | Position.RIGHT.FLAG | Position.TOP.FLAG);
