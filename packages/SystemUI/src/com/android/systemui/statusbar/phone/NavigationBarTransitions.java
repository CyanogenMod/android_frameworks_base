...
public final class NavigationBarTransitions extends BarTransitions {
    ...
    public void applyBackButtonQuiescentAlpha(int mode, boolean animate) {
        ...
        backAlpha = maxVisibleQuiescentAlpha(backAlpha, mView.mCurrentView.findViewWithTag(NavbarEditor.NAVBAR_HOME));
        backAlpha = maxVisibleQuiescentAlpha(backAlpha, mView.mCurrentView.findViewWithTag(NavbarEditor.NAVBAR_RECENT));
        backAlpha = maxVisibleQuiescentAlpha(backAlpha, mView.mCurrentView.findViewWithTag(NavbarEditor.NAVBAR_CONDITIONAL_MENU));
        backAlpha = maxVisibleQuiescentAlpha(backAlpha, mView.mCurrentView.findViewWithTag(NavbarEditor.NAVBAR_ALWAYS_MENU));
        backAlpha = maxVisibleQuiescentAlpha(backAlpha, mView.mCurrentView.findViewWithTag(NavbarEditor.NAVBAR_MENU_BIG));
        if (backAlpha > 0) {
