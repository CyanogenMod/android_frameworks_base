...
public class NavbarEditor implements View.OnTouchListener {
    ...
    public static final ButtonInfo NAVBAR_DPAD_LEFT = new ButtonInfo("dpad_left",
            R.string.navbar_dpad_left, R.string.accessibility_menu,
            KeyEvent.KEYCODE_DPAD_LEFT, R.drawable.ic_sysbar_ime_left,
            R.drawable.ic_sysbar_ime_left, R.drawable.ic_sysbar_ime_left);
    public static final ButtonInfo NAVBAR_DPAD_RIGHT = new ButtonInfo("dpad_right",
            R.string.navbar_dpad_right, R.string.accessibility_menu,
            KeyEvent.KEYCODE_DPAD_RIGHT, R.drawable.ic_sysbar_ime_right,
            R.drawable.ic_sysbar_ime_right, R.drawable.ic_sysbar_ime_right);
