        ...
        for (int c = 0; c < viewParent.getChildCount();c++) {
            ...
            if (cView instanceof KeyButtonView) {
                ...
                if (nextPadding != null) {
                    ...
                    String nextTag = (String) nextKey.getTag();
                    String curTag = (String) cView.getTag();
                    if (nextKey != null && !nextTag.equals(NAVBAR_EMPTY) && curTag != null &&
                            !curTag.equals(NAVBAR_EMPTY)){
                            nextPadding.setVisibility(View.VISIBLE);
                            sCount--;
                    } else if (nextKey != null && nextTag.equals(NAVBAR_EMPTY) && curTag != null &&
                            !curTag.equals(NAVBAR_EMPTY)) {
                        if (sCount > 1) {
                            nextPadding.setVisibility(View.VISIBLE);
                        } else {
