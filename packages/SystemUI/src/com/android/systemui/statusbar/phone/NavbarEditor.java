...
public class NavbarEditor implements OnTouchListener {
    ...
    static {
        ...
        buttonMap.put("Home",
                new ButtonInfo("Home button", R.string.accessibility_home,KeyEvent.KEYCODE_HOME,R.drawable.ic_sysbar_home,R.drawable.ic_sysbar_home_land));
        buttonMap.put("Menu0",
                new ButtonInfo("Menu (autoHide) button" ,R.string.accessibility_menu,KeyEvent.KEYCODE_MENU,R.drawable.ic_sysbar_menu,R.drawable.ic_sysbar_menu_land));
        buttonMap.put("Menu1",
                new ButtonInfo("Menu (alwaysShow) button" ,R.string.accessibility_menu,KeyEvent.KEYCODE_MENU,R.drawable.ic_sysbar_menu,R.drawable.ic_sysbar_menu_land));
        buttonMap.put("Back",
                new ButtonInfo("Back button", R.string.accessibility_back,KeyEvent.KEYCODE_BACK,R.drawable.ic_sysbar_back,R.drawable.ic_sysbar_back_land));
        buttonMap.put("Search",
                new ButtonInfo("Search button",R.string.accessibility_back,KeyEvent.KEYCODE_SEARCH,R.drawable.ic_sysbar_search,R.drawable.ic_sysbar_search_land));
        buttonMap.put("Recent",
                new ButtonInfo("Recent button",R.string.accessibility_recent,0,R.drawable.ic_sysbar_recent,R.drawable.ic_sysbar_recent_land));
        buttonMap.put("Blank",
                new ButtonInfo("Blank button",R.string.accessibility_clear_all,0,R.drawable.ic_sysbar_add,R.drawable.ic_sysbar_add_land));
    }
    ...
    public static final class ButtonInfo {
        ...
        ButtonInfo (String dS, int cD, int mC, int pR, int lR) {
            displayString = dS;
