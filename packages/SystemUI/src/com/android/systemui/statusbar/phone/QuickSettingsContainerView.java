...
public class QuickSettingsContainerView extends FrameLayout {
    ...
    public void updateResources() {
        ...
        if (size == QSSize.Auto || size == QSSize.AutoSmall) {
            mCellWidth = -1;
        } else if (size == QSSize.Small) {
        ...
        if (mSingleRow) {
            ...
            if (mCellWidth > 0) {
                ...
                if (parentWidth <= 0) {
                    ...
                    availableWidth = parentWidth - getPaddingLeft() - getPaddingRight()
                            - (numColumns - 1) * cellGap;
