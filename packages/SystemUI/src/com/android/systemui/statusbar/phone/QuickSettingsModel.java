...
class QuickSettingsModel implements BluetoothStateChangeCallback,
    ...
    void onSystemSoundStateChanged(){
        ...
        if(soundOn){
            ...
            mSystemSoundState.label = mContext.getString(R.string.quick_settings_ringer_on);
        }else{
            mSystemSoundState.enabled = false;
            mSystemSoundState.iconId = R.drawable.ic_qs_ring_off;
            mSystemSoundState.label = mContext.getString(R.string.quick_settings_ringer_off);
        }
    ...
    void onVibrationChanged(){
        ...
        if(am.getRingerMode() == AudioManager.RINGER_MODE_NORMAL && vibrateSetting == AudioManager.VIBRATE_SETTING_ON){
            ...
            mVibrationState.label = mContext.getString(R.string.quick_settings_vibration_on);
            ...
            mVibrationState.label = mContext.getString(R.string.quick_settings_vibration_off);
        }
    ...
    void onVibrationAndSoundChanged(){
        ...
        Resources r = mContext.getResources();
        mVibrationAndSoundState.label = r.getString(R.string.quick_settings_ringer_normal);
