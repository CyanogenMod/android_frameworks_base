...
class QuickSettingsModel implements BluetoothStateChangeCallback,
    ...
    void onSystemVolumeChanged(){
        ...
        if(soundOn){
            ...
            mSystemVolumeState.label = mContext.getString(R.string.quicksettings_ringer_on);
        }else{
            mSystemVolumeState.enabled = false;
            mSystemVolumeState.iconId = R.drawable.stat_ring_off;
            mSystemVolumeState.label = mContext.getString(R.string.quicksettings_ringer_off);
        }
