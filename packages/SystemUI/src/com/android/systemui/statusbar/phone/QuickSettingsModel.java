...
class QuickSettingsModel implements BluetoothStateChangeCallback,
    ...
    void onSystemVolumeChanged(){
        ...
        if(soundOn){
            ...
            mSystemVolumeState.label = mContext.getString(R.string.quicksettings_label_enabled);
        }else{
            mSystemVolumeState.enabled = false;
            mSystemVolumeState.iconId = R.drawable.stat_ring_off;
            mSystemVolumeState.label = mContext.getString(R.string.quicksettings_label_disabled);
        }
    ...
    void onVibrationChanged(){
        ...
        if(am.getRingerMode() == AudioManager.RINGER_MODE_NORMAL && vibrateSetting == AudioManager.VIBRATE_SETTING_ON){
            ...
            mVibrationState.label = mContext.getString(R.string.quicksettings_label_enabled);
            ...
            mVibrationState.label = mContext.getString(R.string.quicksettings_label_disabled);
        }
