...
class QuickSettingsModel implements BluetoothStateChangeCallback,
    ...
    void onVibrationAndSoundChanged(){
        ...
        if(am.getRingerMode() == AudioManager.RINGER_MODE_NORMAL && vibrate){
            //Sound + Vibrate
            mVibrationAndSoundState.iconId = R.drawable.stat_ring_vibrate_on;
            mVibrationAndSoundState.label = r.getString(R.string.quicksettings_ringer_normal_and_vibrate);
        }else if(am.getRingerMode() == AudioManager.RINGER_MODE_NORMAL){
            //Sound
            mVibrationAndSoundState.iconId = R.drawable.stat_ring_on;
            ...
            mVibrationAndSoundState.iconId = R.drawable.stat_ring_off;
            mVibrationAndSoundState.label = r.getString(R.string.quicksettings_ringer_silent);
        }else{
            mVibrationAndSoundState.iconId = R.drawable.stat_vibrate_on;
            mVibrationAndSoundState.label = r.getString(R.string.quicksettings_ringer_vibrate);
        }
