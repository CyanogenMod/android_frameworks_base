...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
        ...
        AccessibilityController.AccessibilityStateChangedCallback, View.OnLongClickListener, LockscreenShortcutsHelper.OnChangeListener {
    ...
    private void updateCameraVisibility() {
        ...
        visible = visible || mShortcutHelper.isTargetCustom(LockscreenShortcutsHelper.Shortcuts.RIGTH_SHORTCUT);
        mCameraImageView.setVisibility(visible ? View.VISIBLE : View.GONE);
    }

    private void updatePhoneVisibility() {
        boolean visible = isPhoneVisible();
        visible = visible || mShortcutHelper.isTargetCustom(LockscreenShortcutsHelper.Shortcuts.LEFT_SHORTCUT);
    ...
    public void launchCamera() {
        ...
        Intent intent;
        if (mShortcutHelper.isTargetCustom(LockscreenShortcutsHelper.Shortcuts.RIGTH_SHORTCUT)) {
            intent = getCameraIntent();
        } else {
            intent = mShortcutHelper.getIntent(LockscreenShortcutsHelper.Shortcuts.RIGTH_SHORTCUT);
        }
    ...
    public String getRightHint() {
        String label = getIndexHint(LockscreenShortcutsHelper.Shortcuts.RIGTH_SHORTCUT);
        if (label == null) {
