...
public class StatusBarIconController implements Tunable {
    ...
    private final ViewTreeObserver mLayoutObserver;
    ...
    private int mSignalClusterWidth, mCenterClockWidth;
    ...
    public StatusBarIconController(Context context, View statusBar, View keyguardStatusBar,
        ...
        mLayoutObserver = mPhoneStatusBar.getStatusBarView().getViewTreeObserver();
        computeMaxWidth();
    ...
    public void cleanup() {
        ...
        mLayoutObserver.removeOnGlobalLayoutListener(mClockLayoutListener);
    }
    ...
    private ViewTreeObserver.OnGlobalLayoutListener mClockLayoutListener = new ViewTreeObserver
        ...
        public void onGlobalLayout() {
            ...
            int clockWidth = mCenterClock.getMeasuredWidth();
            int signalClusterWidth = mSignalCluster.getMeasuredWidth();
            if (mSignalClusterWidth == signalClusterWidth && mCenterClockWidth == clockWidth) {
                return;
            }
            mCenterClockWidth = clockWidth;
            mSignalClusterWidth = signalClusterWidth;
    ...
    public void computeMaxWidth() {
        ...
        mLayoutObserver.addOnGlobalLayoutListener(mClockLayoutListener);
    }
}
