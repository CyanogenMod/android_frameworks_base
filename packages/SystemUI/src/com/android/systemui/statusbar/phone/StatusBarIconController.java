...
public class StatusBarIconController implements Tunable {
    ...
    public void cleanup() {
        ...
        mCenterClock.getViewTreeObserver().removeOnGlobalLayoutListener(mClockLayoutListener);
    }
    ...
    private ViewTreeObserver.OnGlobalLayoutListener mClockLayoutListener = new ViewTreeObserver
        ...
        public void onGlobalLayout() {
            mCenterClock.getViewTreeObserver().removeOnGlobalLayoutListener(this);
    ...
    public void computeMaxWidth() {
        ...
        mCenterClock.getViewTreeObserver().addOnGlobalLayoutListener(mClockLayoutListener);
    }
}
