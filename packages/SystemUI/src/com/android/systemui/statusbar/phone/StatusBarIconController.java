...
public class StatusBarIconController implements Tunable {
    ...
    private ViewTreeObserver.OnGlobalLayoutListener mClockLayoutListener = new ViewTreeObserver
        ...
        private int mSignalClusterWidth;
        private int mCenterClockWidth;
        private int mBatteryTextWidth;
        private int mRightClockWidth;
        private int mBatteryVisibility;
        @Override
        public void onGlobalLayout() {
            ...
            int rightClockWidth = mClock.getWidth();
            int signalClusterWidth = mSignalCluster.getWidth();
            int batteryTextWidth = mBatteryLevelTextView.getWidth();
            int batteryVisibility = mBatteryLevelTextView.getVisibility();
            if (mSignalClusterWidth == signalClusterWidth
                    && mCenterClockWidth == centerClockWidth
                    && mBatteryTextWidth == batteryTextWidth
                    && mBatteryVisibility == batteryVisibility
                    && mRightClockWidth == rightClockWidth) {
                return;
            }
            mCenterClockWidth = centerClockWidth;
