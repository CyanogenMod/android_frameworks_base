...
public class NavigationBarView extends LinearLayout {
    ...
    public void reorient() {
        ...
        final boolean newVertical = getWidth() > 0 && getHeight() > getWidth();
        mEditBar = new NavbarEditor((ViewGroup) mCurrentView.findViewById(R.id.container), mIs600dp ? newVertical : mVertical);
        mEditBar.updateKeys();
        mEditBar.updateLowLights(mCurrentView);
        toggleButtonListener(true);
