 ...
 */
public class ProfilesButton extends PowerButton {
    static final String TAG = "ProfileButton";

    public ProfilesButton() { mType = BUTTON_PROFILES; }

    @Override
    protected void updateState() {

        //icon comes from settings app
        mIcon = R.drawable.ic_settings_profiles;
    ...
    protected void toggleState() {
        ...
        final NotificationManager mNotificationManager = (NotificationManager) mView.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
        mNotificationManager.notify(TAG.hashCode(), mNotificationBuilder.getNotification());
