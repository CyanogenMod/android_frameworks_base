...
public class PieSysInfo extends PieSliceContainer implements ValueAnimator.AnimatorUpdateListener{
    ...
    private void updateData() {
        mNetworkProvider = getNetworkProvider().toUpperCase();
        mSimpleDate = DateFormat.getMediumDateFormat(mContext).format(new Date()).toUpperCase();
        mWifiSsid = getWifiSsid().toUpperCase();
        mBatteryLevelReadable = mController.getBatteryLevelReadable().toUpperCase();
    }
    ...
    private String getWifiSsid() {
        ...
        if (wifiManager != null) {
            ...
            if (connectionInfo != null) {
                ssid = connectionInfo.getWifiSsid().toString();
            }
        }
