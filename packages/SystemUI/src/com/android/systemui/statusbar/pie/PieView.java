    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (mActive) {
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (!mRecentAppsPreloaded && newItem != null && mStatusBar != null) {
                    NavigationButtons.ButtonInfo bi = (NavigationButtons.ButtonInfo) newItem.tag;
            ...
            if (action == MotionEvent.ACTION_UP) {
                if (mRecentAppsPreloaded && mStatusBar != null) {
