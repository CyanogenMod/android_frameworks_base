...
public class PieView extends View implements View.OnTouchListener {
    ...
    public static final int PIE_CONTROL_SIZE_DEFAULT = 37;
    // Should be add to size setting.
    public static final float PIE_CONTROL_SIZE_PLUS = 60;
    ...
    private void getDimensions() {
        mPieScale = (Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.PIE_SIZE, PIE_CONTROL_SIZE_DEFAULT,
                UserHandle.USER_CURRENT) + PIE_CONTROL_SIZE_PLUS) / 100.0f;
    ...
    private void getColors() {
        ...
        float backgroundAlpha = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.PIE_BACKGROUND_ALPHA, 30,
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (mActive) {
            ...
            if ((action == MotionEvent.ACTION_DOWN || action == MotionEvent.ACTION_MOVE)
                ...
                if (ActionConstants.ACTION_RECENTS.equals(clickAction)) {
