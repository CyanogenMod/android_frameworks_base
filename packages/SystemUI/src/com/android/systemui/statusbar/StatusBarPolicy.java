...
public class StatusBarPolicy {
    ...
    public StatusBarPolicy(Context context) {
        ...
        // battery
        mBatteryData = new StatusBarIcon(null, com.android.internal.R.drawable.stat_sys_battery_unknown, 0, 0, false);
    ...
    private final void updateBattery(Intent intent) {
        boolean plugged;
        int level;
        StatusBarIcon mUpdateBatteryData = new StatusBarIcon(null, com.android.internal.R.drawable.stat_sys_battery_unknown, 0, 0,false);
        if(intent != null) {
