...
public class MediaNotificationGuts extends NotificationGuts {
    ...
    protected void onFinishInflate() {
        ...
        mSwitch.setChecked(QueueView.isQueueEnabled(getContext()));
        ...
        mSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                mQueueEnabled = isChecked;
                Settings.System.putInt(getContext().getContentResolver(), "notification_play_queue", isChecked ? 1 : 0);
            }
        });
    }
