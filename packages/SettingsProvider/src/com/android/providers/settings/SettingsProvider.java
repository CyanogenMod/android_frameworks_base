...
public class SettingsProvider extends ContentProvider {
    ...
    private static final String HAS_REPLAYED_DEFAULTS = "has_replayed_defaults";
        ...
        private final class UpgradeController {
            ...
            public void upgradeIfNeededLocked() {
                ...
                if ((oldVersion == newVersion || oldVersion == CM_SETTINGS_DB_VERSION)) {
                    if (oldVersion == CM_SETTINGS_DB_VERSION && shouldForceReplayDefaults()) {
                        forceReplayAOSPDefaults(mUserId);
                        setDefaultsReplayedFlag();
                    }
                    return;
                }
            ...
            private boolean shouldForceReplayDefaults() {
                SharedPreferences sharedPreferences = PreferenceManager
                        .getDefaultSharedPreferences(getContext());
                return sharedPreferences.getBoolean(HAS_REPLAYED_DEFAULTS, false);
            }

            private void setDefaultsReplayedFlag() {
                SharedPreferences sharedPreferences = PreferenceManager
                        .getDefaultSharedPreferences(getContext());
                sharedPreferences.edit().putBoolean(HAS_REPLAYED_DEFAULTS, true).apply();
            }
