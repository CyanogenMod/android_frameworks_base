...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadDefaultThemeSettings(SQLiteStatement stmt) {
        ...
        loadStringSetting(stmt, Configuration.THEME_PACKAGE_NAME_PERSISTENCE_PROPERTY,
                R.string.def_theme_package);
        loadStringSetting(stmt, Configuration.THEME_SYSTEMUI_PACKAGE_NAME_PERSISTENCE_PROPERTY,
                R.string.def_theme_package);
        loadStringSetting(stmt, Configuration.THEME_ICONPACK_PACKAGE_NAME_PERSISTENCE_PROPERTY,
                R.string.def_theme_package);
        loadStringSetting(stmt, Configuration.THEME_FONT_PACKAGE_NAME_PERSISTENCE_PROPERTY,
                R.string.def_theme_package);
    }
