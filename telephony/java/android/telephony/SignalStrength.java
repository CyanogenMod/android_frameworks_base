...
public class SignalStrength implements Parcelable {
    ...
    /** @hide */
    public boolean needsMisleadingRilFeature(String feature) {
    ...
    public int getLevel() {
        ...
        if (isGsm) {
        boolean misleadingRil = needsMisleadingRilFeature("signalstrength");
            level = getLteLevel();
            if (level == SIGNAL_STRENGTH_NONE_OR_UNKNOWN || misleadingRil) {
    ...
    public int getAsuLevel() {
        ...
        if (isGsm) {
        boolean misleadingRil = needsMisleadingRilFeature("signalstrength");
            if (getLteLevel() == SIGNAL_STRENGTH_NONE_OR_UNKNOWN || misleadingRil) {
    ...
    public int getDbm() {
        ...
        boolean misleadingRil = needsMisleadingRilFeature("signalstrength");
            dBm = getLteDbm();
            if (dBm == INVALID) {
                if (getTdScdmaLevel() == SIGNAL_STRENGTH_NONE_OR_UNKNOWN || misleadingRil) {
                    dBm = getGsmDbm();
                } else {
                    dBm = getTdScdmaDbm();
                }
