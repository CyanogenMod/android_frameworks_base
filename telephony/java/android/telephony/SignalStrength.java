...
public class SignalStrength implements Parcelable {
    ...
    public int getLevel() {
        ...
        if (isGsm) {
            ...
            level = getLteLevel();
            if (level == SIGNAL_STRENGTH_NONE_OR_UNKNOWN && (getGsmAsuLevel() != 99 || getTdScdmaAsuLevel() != 255 || getLteAsuLevel() == 255)  && lteChecks) {
    ...
    public int getAsuLevel() {
        ...
        if (isGsm) {
            boolean lteChecks = (getLteRsrp() == INVALID && getLteRsrq() == INVALID && getLteRssnr() == INVALID && getLteSignalStrength() == 99);
            if (getLteLevel() == SIGNAL_STRENGTH_NONE_OR_UNKNOWN && (getGsmAsuLevel() != 99 || getTdScdmaAsuLevel() != 255 || getLteAsuLevel() == 255) && lteChecks) {
