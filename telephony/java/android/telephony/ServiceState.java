...
public class ServiceState implements Parcelable {
    ...
    /** @hide */
    public static final int RIL_RADIO_TECHNOLOGY_HSPAP42 = 30;
    /**
    ...
    public static String rilRadioTechnologyToString(int rt) {
        ...
        switch(rt) {
            ...
            case RIL_RADIO_TECHNOLOGY_HSPAP42:
                rtString = "HSPAP";
                break;
    ...
    public int getNetworkType() {
        ...
        case ServiceState.RIL_RADIO_TECHNOLOGY_HSPAP42:
    ...
    public static boolean isGsm(int radioTechnology) {
        return radioTechnology == RIL_RADIO_TECHNOLOGY_GPRS
                ...
                || radioTechnology == RIL_RADIO_TECHNOLOGY_HSPAP42
