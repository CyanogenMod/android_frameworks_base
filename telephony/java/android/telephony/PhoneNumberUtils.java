...
public class PhoneNumberUtils
{
    ...
    */
    private static boolean isEmergencyNumberForCurrentIso(String number, String country, int slotId) {
        ...
        if (TextUtils.isEmpty(mccEccIso) || isEmergencyIsoMatchCountryIso(mccEccIso, country)) {
            //MCC/ISO is empty or does match, so same region as ECC#'s set from RIL database
            return true;
        }
