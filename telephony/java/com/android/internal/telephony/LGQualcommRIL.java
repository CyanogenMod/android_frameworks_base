...
/**
 * Custom Qualcomm No SimReady ril for LG
 *
 * {@hide}
 */
public class LGQualcommRIL extends QualcommNoSimReadyRIL implements CommandsInterface {
    protected String mAid;

    public LGQualcommRIL(Context context) {
        super(context);
    }

    public LGQualcommRIL(Context context, int networkMode, int cdmaSubscription) {
