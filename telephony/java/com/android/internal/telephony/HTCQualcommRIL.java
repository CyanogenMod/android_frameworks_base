...
public class HTCQualcommRIL extends QualcommSharedRIL implements CommandsInterface {
    ...
    responseIccCardStatus(Parcel p) {
        ...
        // use old needsOldRilFeature method for sprint feature. it would be redundant to make a new one
        // just for naming sake. maybe think about renaming it and using for all "ifdefing of tEh javaz"!
        boolean sprintLteOnCdma = needsOldRilFeature("sprintLteOnCdma");
        ...
        // if sprint lte on cdma dont get subscription here and
