...
*/
    ...
    class IccHandler extends Handler implements Runnable {
        private static final int EVENT_GET_ICC_CARD_STATUS_DONE = 1;
            ...
            switch (paramMessage.what) {
                case 1:
                    ...
                    if (asyncResult.exception != null) {
                        Log.e ("RILJ", "IccCardStatusDone shouldn't return exceptions!", asyncResult.exception);
                        break;
                    }
                    ...
                    if (status.getNumApplications() == 0) {
                        ...
                        if (mPhoneType == RILConstants.CDMA_PHONE) {
                            ...
                            Log.d("RILJ", "This is a CDMA PHONE " + appIndex);
                        } else {
                            appIndex = status.getGsmUmtsSubscriptionAppIndex();
                            Log.d("RILJ", "This is a GSM PHONE " + appIndex);
                        }
                            ...
                            case APPSTATE_PUK:
                                switch (app_type) {
                                    ...
                                    case APPTYPE_RUIM:
                                        ...
                                        break;
                                    default:
                                        Log.e("RILJ", "Currently we don't handle SIMs of type: " + app_type);
                                        return;
                                }
                                break;
                            case APPSTATE_READY:
                    ...
                    break;
                case 2:
                    Message localMsg = obtainMessage(1);
                    mRil.getIccCardStatus(localMsg);
                    break;
                default:
                    break;
            }
        ...
        public void run () {
            mRil.registerForIccStatusChanged(this, 2, null);
