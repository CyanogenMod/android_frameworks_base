...
public class SamsungRIL extends RIL implements CommandsInterface {
    ...
    // Workaround for epicmtd (all Samsung CDMA?) "ring of death" bug:
    //
    ...
    //   epicmtd radio just prior to notice of an incoming call when the voice
    //   call path is muted.  CallNotifier is responsible for stopping all
    //   signal tones (by "playing" the TONE_CDMA_SIGNAL_OFF tone) upon receipt
    //   of a "new ringing connection", prior to unmuting the voice call path.
    //
