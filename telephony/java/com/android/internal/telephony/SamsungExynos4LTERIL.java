...
public class SamsungExynos4LTERIL extends Smdk4210RIL implements CommandsInterface {
    ...
    public SamsungExynos4LTERIL(Context context, int networkMode, int cdmaSubscription) {
