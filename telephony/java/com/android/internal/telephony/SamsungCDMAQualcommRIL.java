...
CommandsInterface {
    ...
    protected Object responseSignalStrength(Parcel p) {
        ...
        if (response[3] > 75) {
            response[2] = response[3] * 2; // multiple by 2 to not have ridiculous values
        } else {
        ...
        // RIL_LTE_SignalStrength. If LTE is not enabled, clear LTE results
    ...
    public void run() {
        mRil.registerForIccStatusChanged(this, EVENT_ICC_STATUS_CHANGED,
                null);
