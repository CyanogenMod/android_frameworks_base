...
public class SamsungExynosT0LTERIL extends Smdk4210RIL implements CommandsInterface {
	...
	public SamsungExynosT0LTERIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription);
        audioManager = (AudioManager)mContext.getSystemService(Context.AUDIO_SERVICE);
    }

    private RILRequest findRequestFromList(int serial) {
