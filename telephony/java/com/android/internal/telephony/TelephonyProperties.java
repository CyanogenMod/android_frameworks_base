...
public interface TelephonyProperties
{
    ...
    * default is true
    */
    static final String PROPERTY_MMS_AUTO_RETRIEVAL = "persist.mms.auto_retrieval";

    /**
    * Set to false to disable MMS automatic retrieval during roaming,
    * default is false
    */
    static final String PROPERTY_MMS_AUTO_RETRIEVAL_ON_ROAMING = "persist.mms.auto_on_roaming";
