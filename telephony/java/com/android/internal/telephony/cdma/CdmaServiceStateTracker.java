    ...
    protected void handlePollStateResult (int what, AsyncResult ar) {
        ...
        if (ar.exception != null) {
            ...
            case EVENT_POLL_STATE_REGISTRATION_CDMA: // Handle RIL_REQUEST_REGISTRATION_STATE.
                ...
                if (states.length == 14 || (SystemProperties.get("ro.telephony.ril_class")
                    .equalsIgnoreCase("mototegraworld") && states.length == 15 )) {
                    try {
                        if (states[0] != null) {
                        ...
                        if(states.length == 15 &&
                           SystemProperties.get("ro.telephony.ril_class").equalsIgnoreCase("mototegraworld")) {
	                        if (states[14] != null) {
	                            Log.w(LOG_TAG, "TegraWorldRIL detected -"
                                           + " CDMA/GSM Hybrid. Extraneous value: "
