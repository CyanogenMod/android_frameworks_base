...
//            Log.v(TAG, "scanFile: " + path + " took " + (t2-t1));
            ...
            if(needToSetSettings) {
                if (notifications) {
                    ...
                    for (int i = 0; i < mPhoneCount; i++) {
                        ...
                        setRingtoneIfNotSet(uri, tableUri, rowId);

                        mDefaultRingtonesSetmDefaultRingtonesSet[i] = true;
                    }
                } else if (alarms) {
    ...
    private void prescan(String filePath, boolean prescanFiles) throws RemoteException {
        ...
        mDefaultRingtonesSet[0] = wasRingtoneAlreadySet(Settings.System.RINGTONE);
        for (int i=1; i< mPhoneCount; i++) {
            mDefaultRingtonesSet[i] = wasRingtoneAlreadySet(Settings.System.RINGTONE + "_" + i);
        }
