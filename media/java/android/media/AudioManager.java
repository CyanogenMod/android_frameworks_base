    ...
    public void handleKeyDown(KeyEvent event, int stream) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_DOWN:
                ...
                int direction = (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN && rotation == Surface.ROTATION_90)
                                || (keyCode == KeyEvent.KEYCODE_VOLUME_UP && rotation != Surface.ROTATION_90)
                                ? ADJUST_RAISE : ADJUST_LOWER;
